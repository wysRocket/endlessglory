...
export const shellStrings = {
  en: {
    seo: {
      ...
      officialBody:
        'endlessglory.vercel.app is the official free browser MMO for the Endless Realm world. Play online with a persistent character, explore solo offline, read the wiki, and follow verified community links from this site.',
    },
    a11y: {
