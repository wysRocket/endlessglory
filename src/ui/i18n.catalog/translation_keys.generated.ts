...
export type TranslationKeyFlat =
  ...
  | 'hudChrome.credits.amountLabel'
  | 'hudChrome.credits.balanceLabel'
  | 'hudChrome.credits.balanceUnit'
  | 'hudChrome.credits.buyButton'
  | 'hudChrome.credits.buyTitle'
  | 'hudChrome.credits.buyUnavailable'
  | 'hudChrome.credits.checkoutClose'
  | 'hudChrome.credits.checkoutFailed'
  | 'hudChrome.credits.checkoutLoading'
  | 'hudChrome.credits.checkoutNotSettled'
  | 'hudChrome.credits.checkoutPending'
  | 'hudChrome.credits.checkoutPendingButton'
  | 'hudChrome.credits.checkoutTitle'
  | 'hudChrome.credits.checkoutUnavailable'
  | 'hudChrome.credits.checkoutWalletRequired'
  | 'hudChrome.credits.checkoutWalletUnsupported'
  | 'hudChrome.credits.close'
  | 'hudChrome.credits.disclosure'
  | 'hudChrome.credits.hideAmounts'
  | 'hudChrome.credits.kindCosmetic'
  | 'hudChrome.credits.kindItem'
  | 'hudChrome.credits.kindSkin'
  | 'hudChrome.credits.loading'
  | 'hudChrome.credits.open'
  | 'hudChrome.credits.railLabel'
  | 'hudChrome.credits.railNativeUnavailable'
  | 'hudChrome.credits.railSol'
  | 'hudChrome.credits.railStripe'
  | 'hudChrome.credits.railUsdc'
  | 'hudChrome.credits.railWoc'
  | 'hudChrome.credits.railWocDiscount'
  | 'hudChrome.credits.railWocUnavailable'
  | 'hudChrome.credits.showAmounts'
  | 'hudChrome.credits.skuRow'
  | 'hudChrome.credits.solBalance'
  | 'hudChrome.credits.spendButton'
  | 'hudChrome.credits.storeCost'
  | 'hudChrome.credits.storeEmpty'
  | 'hudChrome.credits.storeTitle'
  | 'hudChrome.credits.title'
  | 'hudChrome.credits.unavailable'
  | 'hudChrome.credits.usdcBalance'
  | 'hudChrome.credits.wocBalance'
