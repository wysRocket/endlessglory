...
export const hudChromeStrings = {
  ...
  wocStore: {
    ...
    owned: 'Owned',
    needMoreTitle: 'More Credits Required',
    needMoreBody: 'You need {shortfall} more Credits to purchase {item}.',
    cancel: 'Cancel',
    confirmTitle: 'Confirm Cosmetic Purchase',
    confirmBody: 'Purchase {item} for {cost} Credits?',
  ...
  // CREDITS: a server-authoritative soft currency. The game renders only what the
  ...
  credits: {
    ...
    balanceUnit: '{amount} Credits',
    solBalance: 'SOL: {amount}',
    usdcBalance: 'USDC: {amount}',
    wocBalance: 'WOC: {amount}',
    unavailable:
      'The Credits store is unavailable right now. Your balance and purchases are unaffected; please check back shortly.',
    disclosure:
      'Credits is a one-way soft currency: buy it with money and spend it on cosmetics. It cannot be redeemed, transferred, or cashed out.',
    ...
    amountLabel: 'Amount',
    showAmounts: 'Show all Credits amounts',
    hideAmounts: 'Hide extra Credits amounts',
    skuRow: '{usd} for {credits} Credits',
    buyButton: 'Buy',
    ...
    checkoutUnavailable: 'That Credits purchase is not available right now.',
    checkoutWalletRequired: 'Connect a Solana wallet before buying Credits with crypto.',
    checkoutWalletUnsupported: 'This wallet cannot sign and send Solana transactions.',
    checkoutNotSettled:
      'The transaction was sent but Credits was not credited yet. Please try again shortly.',
  },
  theme: {
    preset: 'UI Theme',
  ...
  discord: {
    ...
    swag: {
      ...
      titleChampion: 'Title: Champion of Endless Realm',
