...
export const zh_TW: Partial<Record<TranslationKey, string>> = {
  ...
  'hudChrome.wocStore.balance': 'Credits 餘額',
  'hudChrome.wocStore.buyCredits': '購買 Credits',
  'hudChrome.wocStore.owned': '已擁有',
  'hudChrome.wocStore.needMoreTitle': '需要更多 Credits',
  'hudChrome.wocStore.needMoreBody': '還需要 {shortfall} Credits 才能購買 {item}。',
  'hudChrome.wocStore.cancel': '取消',
  'hudChrome.wocStore.confirmTitle': '確認購買外觀',
  'hudChrome.wocStore.confirmBody': '要用 {cost} Credits 購買 {item} 嗎？',
  ...
  'hudChrome.credits.open': '開啟 Credits',
  'hudChrome.credits.close': '關閉 Credits',
  'hudChrome.credits.loading': '正在載入 Credits…',
  'hudChrome.credits.balanceLabel': '餘額',
  'hudChrome.credits.balanceUnit': '{amount} Credits',
  'hudChrome.credits.unavailable': 'Credits 商店目前無法使用。您的餘額與購買不受影響，請稍後再試。',
  'hudChrome.credits.disclosure':
    'Credits 是單向軟貨幣：可用金錢購買並用於兌換外觀物品，不能贖回、轉讓或兌現。',
  'hudChrome.credits.buyTitle': '購買 Credits',
  'hudChrome.credits.railLabel': '付款方式',
  'hudChrome.credits.railNativeUnavailable': 'SOL/WOC 無法使用',
  'hudChrome.credits.railSol': 'SOL',
  'hudChrome.credits.railStripe': '信用卡',
  'hudChrome.credits.railWoc': 'WOC',
  'hudChrome.credits.railWocDiscount': '優惠 20%',
  'hudChrome.credits.solBalance': 'SOL：{amount}',
  'hudChrome.credits.wocBalance': 'WOC：{amount}',
  'hudChrome.credits.railWocUnavailable': 'WOC 定價目前無法使用。',
  'hudChrome.credits.amountLabel': '數量',
  'hudChrome.credits.showAmounts': '顯示所有 Credits 數量',
  'hudChrome.credits.hideAmounts': '隱藏其他 Credits 數量',
  'hudChrome.credits.skuRow': '{usd} 可購買 {credits} Credits',
  'hudChrome.credits.buyUnavailable': '目前無法購買。',
  'hudChrome.credits.storeTitle': '外觀商店',
  'hudChrome.credits.storeEmpty': '目前沒有可用的外觀物品。',
  'hudChrome.credits.storeCost': '{amount} Credits',
  'hudChrome.credits.spendButton': '兌換',
  'hudChrome.credits.kindCosmetic': '外觀物品',
  'hudChrome.credits.kindItem': '物品',
  'hudChrome.credits.kindSkin': '外觀',
  'hudChrome.credits.buyButton': '購買',
  'hudChrome.credits.checkoutTitle': '完成購買',
  'hudChrome.credits.checkoutClose': '關閉結帳',
  'hudChrome.credits.checkoutLoading': '正在載入結帳頁面…',
  'hudChrome.credits.checkoutPending': '交易處理中。請在錢包中確認，並保持此面板開啟。',
  'hudChrome.credits.checkoutPendingButton': '處理中',
  'hudChrome.credits.checkoutFailed': '無法載入結帳頁面，請再試一次。',
  'hudChrome.credits.checkoutUnavailable': '該 Credits 購買項目目前無法使用。',
  'hudChrome.credits.checkoutWalletRequired': '使用加密貨幣購買 Credits 前，請先連接 Solana 錢包。',
  'hudChrome.credits.checkoutWalletUnsupported': '此錢包無法簽署及傳送 Solana 交易。',
  'hudChrome.credits.checkoutNotSettled': '交易已傳送，但 Credits 尚未入帳，請稍後再試。',
  ...
  'seo.officialBody':
    'endlessglory.vercel.app 是 Endless Realm 世界的官方免費瀏覽器 MMO。你可以用持久角色線上遊玩，也可以離線單人探索、閱讀 wiki，並從本站前往已驗證的社群連結。',
  ...
  'serverUnavailable.body':
    '我們正在重新啟動遊戲服務，Endless Realm 應會很快恢復。此頁面會自動持續檢查。',
  ...
  'hudChrome.discord.swag.titleChampion': '稱號：Endless Realm 勇士',
  ...
  'dashboard.nav.profile': '資料',
  'dashboard.nav.collection': '收藏',
  'dashboard.nav.leaderboard': '排行榜',
  'dashboard.login.username': '使用者名稱',
  'dashboard.login.password': '密碼',
  'dashboard.login.registerPrompt': '還沒有帳號？',
  'dashboard.login.registerLink': '立即建立',
  'dashboard.login.twoFactorLabel': '6 位數驗證碼或救援碼',
  'dashboard.login.twoFactorSubmit': '驗證',
  'dashboard.register.title': '建立帳號',
  'dashboard.register.email': '電子郵件',
  'dashboard.register.submit': '建立帳號',
  'dashboard.loggedOut.message': '請登入以查看你的帳號。',
  'dashboard.profile.title': '資料',
  'dashboard.profile.noCharacters': '尚無角色。',
  'dashboard.collection.title': '收藏',
  'dashboard.collection.empty': '尚未獲得任何功績。',
  'dashboard.collection.loadMore': '載入更多',
  'dashboard.leaderboard.title': '排行榜',
  'dashboard.leaderboard.tabXp': '經驗值',
  'dashboard.leaderboard.tabArena': '競技場',
  'dashboard.error.retry': '重試',
  'dashboard.error.generic': '發生錯誤。',
