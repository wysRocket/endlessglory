...
export const it_IT: Partial<Record<TranslationKey, string>> = {
  ...
  'seo.officialBody':
    "endlessglory.vercel.app è l'MMO gratuito ufficiale da browser del mondo Endless Realm. Gioca online con un personaggio persistente, esplora offline in solitaria, leggi il wiki e segui i link della community verificati da questo sito.",
  ...
  'serverUnavailable.body':
    'Stiamo riavviando il servizio di gioco e prevediamo che Endless Realm torni a breve. Questa pagina continuerà a controllare automaticamente.',
  ...
  'hudChrome.discord.swag.titleChampion': 'Titolo: Campione di Endless Realm',
  ...
  'hudChrome.credits.amountLabel': 'Quantità',
  'hudChrome.credits.balanceLabel': 'Saldo',
  'hudChrome.credits.balanceUnit': '{amount} Credits',
  'hudChrome.credits.buyButton': 'Acquista',
  'hudChrome.credits.buyTitle': 'Acquista Credits',
  'hudChrome.credits.buyUnavailable': "L'acquisto non è disponibile al momento.",
  'hudChrome.credits.checkoutClose': 'Chiudi il pagamento',
  'hudChrome.credits.checkoutFailed': 'Impossibile caricare il pagamento. Riprova.',
  'hudChrome.credits.checkoutLoading': 'Caricamento del pagamento...',
  'hudChrome.credits.checkoutNotSettled':
    'La transazione è stata inviata, ma Credits non è ancora stato accreditato. Riprova tra poco.',
  'hudChrome.credits.checkoutPending':
    'Transazione in corso. Conferma nel tuo portafoglio e mantieni questo pannello aperto.',
  'hudChrome.credits.checkoutPendingButton': 'In elaborazione',
  'hudChrome.credits.checkoutTitle': "Completa l'acquisto",
  'hudChrome.credits.checkoutUnavailable': "L'acquisto di Credits non è disponibile al momento.",
  'hudChrome.credits.checkoutWalletRequired':
    'Collega un portafoglio Solana prima di acquistare Credits con criptovaluta.',
  'hudChrome.credits.checkoutWalletUnsupported':
    'Questo portafoglio non può firmare e inviare transazioni Solana.',
  'hudChrome.credits.close': 'Chiudi Credits',
  'hudChrome.credits.disclosure':
    'Credits è una valuta virtuale a senso unico: puoi acquistarlo con denaro reale e spenderlo in cosmetici. Non può essere riscattato, trasferito o convertito in denaro.',
  'hudChrome.credits.hideAmounts': 'Nascondi importi extra di Credits',
  'hudChrome.credits.kindCosmetic': 'Cosmetico',
  'hudChrome.credits.kindItem': 'Oggetto',
  'hudChrome.credits.kindSkin': 'Aspetto',
  'hudChrome.credits.loading': 'Caricamento di Credits...',
  'hudChrome.credits.open': 'Apri Credits',
  'hudChrome.credits.railLabel': 'Metodo di pagamento',
  'hudChrome.credits.railNativeUnavailable': 'SOL/WOC non disponibile.',
  'hudChrome.credits.railSol': 'SOL',
  'hudChrome.credits.railStripe': 'Carta',
  'hudChrome.credits.railWoc': 'WOC',
  'hudChrome.credits.railWocDiscount': '20% di sconto',
  'hudChrome.credits.railWocUnavailable': 'I prezzi WOC non sono disponibili al momento.',
  'hudChrome.credits.showAmounts': 'Mostra tutti gli importi di Credits',
  'hudChrome.credits.skuRow': '{usd} per {credits} Credits',
  'hudChrome.credits.solBalance': 'SOL: {amount}',
  'hudChrome.credits.spendButton': 'Riscatta',
  'hudChrome.credits.storeCost': '{amount} Credits',
  'hudChrome.credits.storeEmpty': 'Nessun cosmetico è disponibile al momento.',
  'hudChrome.credits.storeTitle': 'Negozio di cosmetici',
  ...
  'hudChrome.wocStore.balance': 'Saldo Credits',
  'hudChrome.wocStore.buyCredits': 'Acquista Credits',
  ...
  'hudChrome.wocStore.confirmBody': 'Acquistare {item} per {cost} Credits?',
  ...
  'hudChrome.wocStore.needMoreBody': 'Ti servono altri {shortfall} Credits per acquistare {item}.',
  'hudChrome.wocStore.needMoreTitle': 'Servono altri Credits',
  ...
  'hudChrome.credits.usdcBalance': 'Saldo USDC: {amount}',
