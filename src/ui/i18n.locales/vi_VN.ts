...
export const vi_VN: Partial<Record<TranslationKey, string>> = {
  ...
  'seo.genre': 'MMORPG',
  'seo.officialBody':
    'endlessglory.vercel.app là trang MMO trên trình duyệt miễn phí chính thức cho thế giới Endless Realm. Chơi trực tuyến với một nhân vật bền vững, khám phá đơn lẻ ngoại tuyến, đọc wiki và theo dõi các liên kết cộng đồng đã được xác minh từ trang này.',
  ...
  'serverUnavailable.body':
    'Chúng tôi đang khởi động lại dịch vụ trò chơi và dự kiến Endless Realm sẽ trở lại trong giây lát. Trang này sẽ tự động tiếp tục kiểm tra.',
  ...
  'hudChrome.discord.swag.titleChampion': 'Danh Hiệu: Nhà Vô Địch Endless Realm',
  ...
  'hudChrome.credits.amountLabel': 'Số lượng',
  'hudChrome.credits.balanceLabel': 'Số dư',
  'hudChrome.credits.balanceUnit': '{amount} Credits',
  'hudChrome.credits.buyButton': 'Mua',
  'hudChrome.credits.buyTitle': 'Mua Credits',
  'hudChrome.credits.buyUnavailable': 'Mua hàng không có sẵn ngay bây giờ.',
  'hudChrome.credits.checkoutClose': 'Đóng thanh toán',
  'hudChrome.credits.checkoutFailed': 'Không thể tải thanh toán. Vui lòng thử lại.',
  'hudChrome.credits.checkoutLoading': 'Đang tải thanh toán...',
  'hudChrome.credits.checkoutNotSettled':
    'Giao dịch đã được gửi nhưng Credits vẫn chưa được ghi có. Vui lòng thử lại trong thời gian ngắn.',
  'hudChrome.credits.checkoutPending':
    'Giao dịch đang được tiến hành. Xác nhận trong ví của bạn và giữ bảng này mở.',
  'hudChrome.credits.checkoutPendingButton': 'Xử lý',
  'hudChrome.credits.checkoutTitle': 'Hoàn tất mua hàng',
  'hudChrome.credits.checkoutUnavailable': 'Việc mua Credits đó hiện không khả dụng.',
  'hudChrome.credits.checkoutWalletRequired':
    'Kết nối ví Solana trước khi mua Credits bằng tiền điện tử.',
  'hudChrome.credits.checkoutWalletUnsupported': 'Ví này không thể ký và gửi giao dịch Solana.',
  'hudChrome.credits.close': 'Đóng Credits',
  'hudChrome.credits.disclosure':
    'Credits là loại tiền mềm một chiều: mua bằng tiền và tiêu vào mỹ phẩm. Nó không thể được đổi, chuyển nhượng hoặc rút tiền mặt.',
  'hudChrome.credits.hideAmounts': 'Ẩn số lượng Credits bổ sung',
  'hudChrome.credits.kindCosmetic': 'Mỹ phẩm',
  'hudChrome.credits.kindItem': 'Vật phẩm',
  'hudChrome.credits.kindSkin': 'Ngoại hình',
  'hudChrome.credits.loading': 'Đang tải Credits...',
  'hudChrome.credits.open': 'Mở Credits',
  'hudChrome.credits.railLabel': 'Phương thức thanh toán',
  'hudChrome.credits.railNativeUnavailable': 'SOL/WOC hiện không khả dụng.',
  'hudChrome.credits.railSol': 'SOL',
  'hudChrome.credits.railStripe': 'Thẻ',
  'hudChrome.credits.railWoc': 'WOC',
  'hudChrome.credits.railWocDiscount': 'Giảm 20%',
  'hudChrome.credits.railWocUnavailable': 'Giá WOC hiện không có sẵn.',
  'hudChrome.credits.showAmounts': 'Hiển thị tất cả số lượng Credits',
  'hudChrome.credits.skuRow': '{usd} đổi lấy {credits} Credits',
  'hudChrome.credits.solBalance': 'SOL: {amount}',
  'hudChrome.credits.spendButton': 'Đổi',
  'hudChrome.credits.storeCost': '{amount} Credits',
  'hudChrome.credits.storeEmpty': 'Không có mỹ phẩm có sẵn ngay bây giờ.',
  'hudChrome.credits.storeTitle': 'Cửa hàng mỹ phẩm',
  ...
  'hudChrome.wocStore.balance': 'Số dư Credits',
  'hudChrome.wocStore.buyCredits': 'Mua Credits',
  ...
  'hudChrome.wocStore.confirmBody': 'Mua {item} với giá {cost} Credits?',
  ...
  'hudChrome.wocStore.needMoreBody': 'Bạn cần thêm {shortfall} Credits để mua {item}.',
  'hudChrome.wocStore.needMoreTitle': 'Cần thêm Credits',
