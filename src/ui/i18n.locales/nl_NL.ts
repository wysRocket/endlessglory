...
export const nl_NL: Partial<Record<TranslationKey, string>> = {
  ...
  'seo.genre': 'MMORPG',
  'seo.officialBody':
    'endlessglory.vercel.app is de officiële gratis browser-MMO voor de Endless Realm-wereld. Speel online met een blijvend personage, verken solo offline, lees de wiki en volg geverifieerde communitylinks vanaf deze site.',
  ...
  'serverUnavailable.body':
    'We herstarten de gameservice en verwachten dat Endless Realm binnenkort weer terug is. Deze pagina blijft automatisch controleren.',
  ...
  'hudChrome.discord.swag.titleChampion': 'Titel: Kampioen van Endless Realm',
  ...
  'hudChrome.credits.amountLabel': 'Hoeveelheid',
  'hudChrome.credits.balanceLabel': 'Saldo',
  'hudChrome.credits.balanceUnit': '{amount} Credits',
  'hudChrome.credits.buyButton': 'Kopen',
  'hudChrome.credits.buyTitle': 'Credits kopen',
  'hudChrome.credits.buyUnavailable': 'Aankoop is momenteel niet mogelijk.',
  'hudChrome.credits.checkoutClose': 'Betaalvenster sluiten',
  'hudChrome.credits.checkoutFailed': 'Afrekenen kon niet worden geladen. Probeer het opnieuw.',
  'hudChrome.credits.checkoutLoading': 'Afrekenen laden...',
  'hudChrome.credits.checkoutNotSettled':
    'De transactie is verzonden, maar Credits is nog niet gecrediteerd. Probeer het binnenkort opnieuw.',
  'hudChrome.credits.checkoutPending':
    'Transactie in behandeling. Bevestig deze in je wallet en houd dit paneel open.',
  'hudChrome.credits.checkoutPendingButton': 'Bezig',
  'hudChrome.credits.checkoutTitle': 'Aankoop voltooien',
  'hudChrome.credits.checkoutUnavailable': 'Die aankoop van Credits is momenteel niet beschikbaar.',
  'hudChrome.credits.checkoutWalletRequired':
    'Koppel een Solana-wallet voordat je Credits met cryptovaluta koopt.',
  'hudChrome.credits.checkoutWalletUnsupported':
    'Deze wallet kan geen Solana-transacties ondertekenen en verzenden.',
  'hudChrome.credits.close': 'Credits sluiten',
  'hudChrome.credits.disclosure':
    'Credits is een virtuele valuta die maar één kant op gaat: koop het met geld en besteed het aan cosmetica. Het kan niet worden ingewisseld, overgedragen of uitbetaald.',
  'hudChrome.credits.hideAmounts': 'Verberg extra Credits-bedragen',
  'hudChrome.credits.kindCosmetic': 'Cosmetica',
  'hudChrome.credits.kindItem': 'Item',
  'hudChrome.credits.kindSkin': 'Skin',
  'hudChrome.credits.loading': 'Credits laden...',
  'hudChrome.credits.open': 'Credits openen',
  'hudChrome.credits.railLabel': 'Betaalmethode',
  'hudChrome.credits.railNativeUnavailable': 'SOL/WOC staat uit.',
  'hudChrome.credits.railSol': 'SOL',
  'hudChrome.credits.railStripe': 'Kaart',
  'hudChrome.credits.railWoc': 'WOC',
  'hudChrome.credits.railWocDiscount': '20% korting',
  'hudChrome.credits.railWocUnavailable': 'WOC-prijzen zijn momenteel niet beschikbaar.',
  'hudChrome.credits.showAmounts': 'Toon alle Credits-bedragen',
  'hudChrome.credits.skuRow': '{usd} voor {credits} Credits',
  'hudChrome.credits.solBalance': 'SOL: {amount}',
  'hudChrome.credits.spendButton': 'Besteden',
  'hudChrome.credits.storeCost': '{amount} Credits',
  'hudChrome.credits.storeEmpty': 'Er zijn momenteel geen cosmetica beschikbaar.',
  'hudChrome.credits.storeTitle': 'Cosmetische winkel',
  ...
  'hudChrome.wocStore.buyCredits': 'Credits kopen',
  ...
  'hudChrome.wocStore.confirmBody': '{item} voor {cost} Credits kopen?',
  ...
  'hudChrome.wocStore.needMoreBody': 'Je hebt {shortfall} meer Credits nodig om {item} te kopen.',
  'hudChrome.wocStore.needMoreTitle': 'Meer Credits vereist',
