...
export const de_DE: Partial<Record<TranslationKey, string>> = {
  ...
  'seo.officialBody':
    'endlessglory.vercel.app ist das offizielle kostenlose Browser-MMO für die Welt Endless Realm. Spiele online mit einem dauerhaften Charakter, erkunde solo offline, lies das Wiki und folge den verifizierten Community-Links auf dieser Website.',
  ...
  'serverUnavailable.body':
    'Wir starten den Spieldienst neu und erwarten, dass Endless Realm bald zurückkehrt. Diese Seite prüft automatisch weiter.',
  ...
  'hudChrome.discord.swag.titleChampion': 'Titel: Champion von Endless Realm',
  ...
  'hudChrome.credits.amountLabel': 'Menge',
  'hudChrome.credits.balanceLabel': 'Guthaben',
  'hudChrome.credits.balanceUnit': '{amount} Credits',
  'hudChrome.credits.buyButton': 'Kaufen',
  'hudChrome.credits.buyTitle': 'Credits kaufen',
  'hudChrome.credits.buyUnavailable': 'Käufe sind derzeit nicht verfügbar.',
  'hudChrome.credits.checkoutClose': 'Bezahlvorgang schließen',
  'hudChrome.credits.checkoutFailed':
    'Der Bezahlvorgang konnte nicht geladen werden. Bitte versuche es erneut.',
  'hudChrome.credits.checkoutLoading': 'Bezahlvorgang wird geladen...',
  'hudChrome.credits.checkoutNotSettled':
    'Die Transaktion wurde gesendet, aber das Credits wurde noch nicht gutgeschrieben. Bitte versuche es gleich noch einmal.',
  ...
  'hudChrome.credits.checkoutPendingButton': 'Wird verarbeitet',
  'hudChrome.credits.checkoutTitle': 'Kauf abschließen',
  'hudChrome.credits.checkoutUnavailable': 'Dieser Credits-Kauf ist derzeit nicht verfügbar.',
  'hudChrome.credits.checkoutWalletRequired':
    'Verbinde eine Solana-Wallet, bevor du Credits mit Kryptowährung kaufst.',
  'hudChrome.credits.checkoutWalletUnsupported':
    'Diese Wallet kann Solana-Transaktionen weder signieren noch senden.',
  'hudChrome.credits.close': 'Credits-Fenster schließen',
  'hudChrome.credits.disclosure':
    'Credits ist eine nicht rücktauschbare Spielwährung: Du kaufst es mit echtem Geld und gibst es für kosmetische Inhalte aus. Es kann weder eingelöst noch übertragen oder ausgezahlt werden.',
  'hudChrome.credits.hideAmounts': 'Zusätzliche Credits-Mengen ausblenden',
  'hudChrome.credits.kindCosmetic': 'Kosmetik',
  'hudChrome.credits.kindItem': 'Gegenstand',
  'hudChrome.credits.kindSkin': 'Skin',
  'hudChrome.credits.loading': 'Credits wird geladen...',
  'hudChrome.credits.open': 'Credits-Fenster öffnen',
  'hudChrome.credits.railLabel': 'Zahlungsart',
  'hudChrome.credits.railNativeUnavailable': 'SOL/WOC deaktiviert.',
  'hudChrome.credits.railSol': 'SOL',
  'hudChrome.credits.railStripe': 'Karte',
  'hudChrome.credits.railWoc': 'WOC',
  'hudChrome.credits.railWocDiscount': '20% Rabatt',
  'hudChrome.credits.railWocUnavailable': 'WOC-Preise sind derzeit nicht verfügbar.',
  'hudChrome.credits.showAmounts': 'Alle Credits-Mengen anzeigen',
  'hudChrome.credits.skuRow': '{credits} Credits für {usd}',
  'hudChrome.credits.solBalance': 'SOL: {amount}',
  'hudChrome.credits.spendButton': 'Einlösen',
  'hudChrome.credits.storeCost': '{amount} Credits',
  'hudChrome.credits.storeEmpty': 'Derzeit sind keine kosmetischen Inhalte verfügbar.',
  'hudChrome.credits.storeTitle': 'Kosmetikshop',
  ...
  'hudChrome.wocStore.balance': 'Credits-Guthaben',
  'hudChrome.wocStore.buyCredits': 'Credits kaufen',
  ...
  'hudChrome.wocStore.confirmBody': '{item} für {cost} Credits kaufen?',
  ...
  'hudChrome.wocStore.needMoreBody': 'Dir fehlen {shortfall} Credits, um {item} zu kaufen.',
  'hudChrome.wocStore.needMoreTitle': 'Mehr Credits benötigt',
