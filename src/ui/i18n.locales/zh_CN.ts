...
export const zh_CN: Partial<Record<TranslationKey, string>> = {
  ...
  'hudChrome.wocStore.balance': 'Credits 余额',
  'hudChrome.wocStore.buyCredits': '购买 Credits',
  'hudChrome.wocStore.owned': '已拥有',
  'hudChrome.wocStore.needMoreTitle': '需要更多 Credits',
  'hudChrome.wocStore.needMoreBody': '还需要 {shortfall} Credits 才能购买 {item}。',
  'hudChrome.wocStore.cancel': '取消',
  'hudChrome.wocStore.confirmTitle': '确认购买外观',
  'hudChrome.wocStore.confirmBody': '要用 {cost} Credits 购买 {item} 吗？',
  ...
  'hudChrome.credits.open': '打开 Credits',
  'hudChrome.credits.close': '关闭 Credits',
  'hudChrome.credits.loading': '正在加载 Credits…',
  'hudChrome.credits.balanceLabel': '余额',
  'hudChrome.credits.balanceUnit': '{amount} Credits',
  'hudChrome.credits.unavailable':
    'Credits 商店暂时不可用。您的余额和购买不会受到影响，请稍后再试。',
  'hudChrome.credits.disclosure':
    'Credits 是单向软货币：可用真钱购买并用于兑换外观物品，不能赎回、转让或兑现。',
  'hudChrome.credits.buyTitle': '购买 Credits',
  'hudChrome.credits.railLabel': '付款方式',
  'hudChrome.credits.railNativeUnavailable': 'SOL/WOC 不可用',
  'hudChrome.credits.railSol': 'SOL',
  'hudChrome.credits.railStripe': '银行卡',
  'hudChrome.credits.railWoc': 'WOC',
  'hudChrome.credits.railWocDiscount': '优惠 20%',
  'hudChrome.credits.solBalance': 'SOL：{amount}',
  'hudChrome.credits.wocBalance': 'WOC：{amount}',
  'hudChrome.credits.railWocUnavailable': 'WOC 定价暂时不可用。',
  'hudChrome.credits.amountLabel': '数量',
  'hudChrome.credits.showAmounts': '显示所有 Credits 数量',
  'hudChrome.credits.hideAmounts': '隐藏其他 Credits 数量',
  'hudChrome.credits.skuRow': '{usd} 可购买 {credits} Credits',
  'hudChrome.credits.buyUnavailable': '暂时无法购买。',
  'hudChrome.credits.storeTitle': '外观商店',
  'hudChrome.credits.storeEmpty': '目前没有可用的外观物品。',
  'hudChrome.credits.storeCost': '{amount} Credits',
  'hudChrome.credits.spendButton': '兑换',
  'hudChrome.credits.kindCosmetic': '外观物品',
  'hudChrome.credits.kindItem': '物品',
  'hudChrome.credits.kindSkin': '外观',
  'hudChrome.credits.buyButton': '购买',
  'hudChrome.credits.checkoutTitle': '完成购买',
  'hudChrome.credits.checkoutClose': '关闭结账',
  'hudChrome.credits.checkoutLoading': '正在加载结账页面…',
  'hudChrome.credits.checkoutPending': '交易正在进行。请在钱包中确认，并保持此面板打开。',
  'hudChrome.credits.checkoutPendingButton': '处理中',
  'hudChrome.credits.checkoutFailed': '无法加载结账页面，请重试。',
  'hudChrome.credits.checkoutUnavailable': '该 Credits 购买项目暂时不可用。',
  'hudChrome.credits.checkoutWalletRequired': '使用加密货币购买 Credits 前，请先连接 Solana 钱包。',
  'hudChrome.credits.checkoutWalletUnsupported': '此钱包无法签署和发送 Solana 交易。',
  'hudChrome.credits.checkoutNotSettled': '交易已发送，但 Credits 尚未到账，请稍后重试。',
  ...
  'seo.officialBody':
    'endlessglory.vercel.app 是 Endless Realm 世界的官方免费浏览器 MMO。你可以用持久角色在线游玩，也可以离线单人探索，阅读 wiki，并从本站访问已验证的社区链接。',
  ...
  'serverUnavailable.body':
    '我们正在重启游戏服务，Endless Realm 应会很快恢复。此页面会自动继续检查。',
  ...
  'hudChrome.discord.swag.titleChampion': '称号：Endless Realm 勇士',
  ...
  'dashboard.login.username': '用户名',
  'dashboard.login.password': '密码',
  'dashboard.login.registerPrompt': '还没有账号？',
  'dashboard.login.registerLink': '立即创建',
  'dashboard.login.twoFactorLabel': '6 位验证码或恢复码',
  'dashboard.login.twoFactorSubmit': '验证',
  'dashboard.register.title': '创建账号',
  'dashboard.register.email': '邮箱',
  'dashboard.register.submit': '创建账号',
  'dashboard.loggedOut.message': '请登录以查看你的账号。',
  'dashboard.profile.title': '资料',
  'dashboard.profile.noCharacters': '暂无角色。',
  'dashboard.collection.title': '收藏',
  'dashboard.collection.empty': '尚未获得任何功绩。',
  'dashboard.collection.loadMore': '加载更多',
  'dashboard.leaderboard.title': '排行榜',
  'dashboard.leaderboard.tabXp': '经验值',
  'dashboard.leaderboard.tabArena': '竞技场',
  'dashboard.error.retry': '重试',
  'dashboard.error.generic': '出现错误。',
