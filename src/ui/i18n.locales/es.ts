...
export const es: Partial<Record<TranslationKey, string>> = {
  ...
  'seo.officialBody':
    'endlessglory.vercel.app es el MMO de navegador gratuito oficial del mundo Endless Realm. Juega en línea con un personaje persistente, explora en solitario sin conexión, lee la wiki y sigue los enlaces comunitarios verificados desde este sitio.',
  ...
  'serverUnavailable.body':
    'Estamos reiniciando el servicio del juego y esperamos que Endless Realm vuelva pronto. Esta página seguirá comprobándolo automáticamente.',
  ...
  'hudChrome.discord.swag.titleChampion': 'Título: Campeón de Endless Realm',
  ...
  'hudChrome.credits.amountLabel': 'Cantidad',
  'hudChrome.credits.balanceLabel': 'Saldo',
  'hudChrome.credits.balanceUnit': '{amount} Credits',
  'hudChrome.credits.buyButton': 'Comprar',
  'hudChrome.credits.buyTitle': 'Comprar Credits',
  'hudChrome.credits.buyUnavailable': 'Las compras no están disponibles en este momento.',
  'hudChrome.credits.checkoutClose': 'Cerrar el pago',
  'hudChrome.credits.checkoutFailed': 'No se pudo cargar el pago. Inténtalo de nuevo.',
  'hudChrome.credits.checkoutLoading': 'Cargando el pago...',
  'hudChrome.credits.checkoutNotSettled':
    'La transacción se envió, pero el Credits aún no se ha abonado. Vuelve a intentarlo dentro de poco.',
  'hudChrome.credits.checkoutPending':
    'Transacción en curso. Confírmala en tu cartera y mantén abierto este panel.',
  'hudChrome.credits.checkoutPendingButton': 'Procesando',
  'hudChrome.credits.checkoutTitle': 'Completar compra',
  'hudChrome.credits.checkoutUnavailable':
    'Esa compra de Credits no está disponible en este momento.',
  'hudChrome.credits.checkoutWalletRequired':
    'Conecta una cartera de Solana antes de comprar Credits con criptomonedas.',
  'hudChrome.credits.checkoutWalletUnsupported':
    'Esta cartera no puede firmar ni enviar transacciones de Solana.',
  'hudChrome.credits.close': 'Cerrar Credits',
  'hudChrome.credits.disclosure':
    'Credits es una moneda virtual unidireccional: se compra con dinero y se gasta en cosméticos. No se puede canjear, transferir ni convertir en dinero.',
  'hudChrome.credits.hideAmounts': 'Ocultar cantidades adicionales de Credits',
  'hudChrome.credits.kindCosmetic': 'Cosmético',
  'hudChrome.credits.kindItem': 'Objeto',
  'hudChrome.credits.kindSkin': 'Apariencia',
  'hudChrome.credits.loading': 'Cargando Credits...',
  'hudChrome.credits.open': 'Abrir Credits',
  'hudChrome.credits.railLabel': 'Forma de pago',
  'hudChrome.credits.railNativeUnavailable': 'SOL/WOC no disponible.',
  'hudChrome.credits.railSol': 'SOL',
  'hudChrome.credits.railStripe': 'Tarjeta',
  'hudChrome.credits.railWoc': 'WOC',
  'hudChrome.credits.railWocDiscount': '20 % de descuento',
  'hudChrome.credits.railWocUnavailable':
    'Los precios en WOC no están disponibles en este momento.',
  'hudChrome.credits.showAmounts': 'Mostrar todas las cantidades de Credits',
  'hudChrome.credits.skuRow': '{credits} Credits por {usd}',
  'hudChrome.credits.solBalance': 'SOL: {amount}',
  'hudChrome.credits.spendButton': 'Canjear',
  'hudChrome.credits.storeCost': '{amount} Credits',
  'hudChrome.credits.storeEmpty': 'No hay cosméticos disponibles en este momento.',
  'hudChrome.credits.storeTitle': 'Tienda de cosméticos',
  ...
  'hudChrome.wocStore.balance': 'Saldo de Credits',
  'hudChrome.wocStore.buyCredits': 'Comprar Credits',
  ...
  'hudChrome.wocStore.confirmBody': '¿Comprar {item} por {cost} Credits?',
  ...
  'hudChrome.wocStore.needMoreBody': 'Te faltan {shortfall} Credits para comprar {item}.',
  'hudChrome.wocStore.needMoreTitle': 'Necesitas más Credits',
  ...
  'hudChrome.credits.usdcBalance': 'Saldo en USDC: {amount}',
