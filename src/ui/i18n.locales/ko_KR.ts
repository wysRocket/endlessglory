...
export const ko_KR: Partial<Record<TranslationKey, string>> = {
  ...
  'hudChrome.wocStore.balance': 'Credits 잔액',
  'hudChrome.wocStore.buyCredits': 'Credits 구매',
  'hudChrome.wocStore.owned': '보유 중',
  'hudChrome.wocStore.needMoreTitle': 'Credits이 더 필요합니다',
  'hudChrome.wocStore.needMoreBody': '{item} 구매에 Credits {shortfall}개가 더 필요합니다.',
  'hudChrome.wocStore.cancel': '취소',
  'hudChrome.wocStore.confirmTitle': '꾸미기 상품 구매 확인',
  'hudChrome.wocStore.confirmBody': '{item}을(를) {cost} Credits으로 구매할까요?',
  ...
  'hudChrome.credits.open': 'Credits 열기',
  'hudChrome.credits.close': 'Credits 닫기',
  'hudChrome.credits.loading': 'Credits 불러오는 중…',
  'hudChrome.credits.balanceLabel': '잔액',
  'hudChrome.credits.balanceUnit': '{amount} Credits',
  'hudChrome.credits.unavailable':
    '현재 Credits 상점을 이용할 수 없습니다. 잔액과 구매 내역에는 영향이 없으니 잠시 후 다시 확인해 주세요.',
  'hudChrome.credits.disclosure':
    'Credits은 단방향 게임 화폐입니다. 현금으로 구매해 꾸미기 상품에 사용할 수 있으며 환전, 양도 또는 현금화할 수 없습니다.',
  'hudChrome.credits.buyTitle': 'Credits 구매',
  'hudChrome.credits.railLabel': '결제 수단',
  'hudChrome.credits.railNativeUnavailable': 'SOL/WOC 사용 불가',
  'hudChrome.credits.railSol': 'SOL',
  'hudChrome.credits.railStripe': '카드',
  'hudChrome.credits.railWoc': 'WOC',
  'hudChrome.credits.railWocDiscount': '20% 할인',
  'hudChrome.credits.solBalance': 'SOL: {amount}',
  'hudChrome.credits.wocBalance': 'WOC: {amount}',
  'hudChrome.credits.railWocUnavailable': '현재 WOC 가격을 이용할 수 없습니다.',
  'hudChrome.credits.amountLabel': '수량',
  'hudChrome.credits.showAmounts': '모든 Credits 수량 표시',
  'hudChrome.credits.hideAmounts': '추가 Credits 수량 숨기기',
  'hudChrome.credits.skuRow': '{usd}에 {credits} Credits',
  'hudChrome.credits.buyUnavailable': '현재 구매할 수 없습니다.',
  'hudChrome.credits.storeTitle': '꾸미기 상점',
  'hudChrome.credits.storeEmpty': '현재 이용 가능한 꾸미기 상품이 없습니다.',
  'hudChrome.credits.storeCost': '{amount} Credits',
  'hudChrome.credits.spendButton': '교환',
  'hudChrome.credits.kindCosmetic': '꾸미기 상품',
  'hudChrome.credits.kindItem': '아이템',
  'hudChrome.credits.kindSkin': '스킨',
  'hudChrome.credits.buyButton': '구매',
  'hudChrome.credits.checkoutTitle': '구매 완료',
  'hudChrome.credits.checkoutClose': '결제 닫기',
  'hudChrome.credits.checkoutLoading': '결제 불러오는 중…',
  'hudChrome.credits.checkoutPending':
    '거래가 진행 중입니다. 지갑에서 확인하고 이 패널을 열어 두세요.',
  'hudChrome.credits.checkoutPendingButton': '처리 중',
  'hudChrome.credits.checkoutFailed': '결제를 불러오지 못했습니다. 다시 시도해 주세요.',
  'hudChrome.credits.checkoutUnavailable': '해당 Credits 구매는 현재 이용할 수 없습니다.',
  'hudChrome.credits.checkoutWalletRequired':
    '암호화폐로 Credits을 구매하기 전에 Solana 지갑을 연결하세요.',
  'hudChrome.credits.checkoutWalletUnsupported':
    '이 지갑은 Solana 거래에 서명하거나 전송할 수 없습니다.',
  'hudChrome.credits.checkoutNotSettled':
    '거래는 전송됐지만 Credits이 아직 지급되지 않았습니다. 잠시 후 다시 시도해 주세요.',
  ...
  'seo.officialBody':
    'endlessglory.vercel.app은 Endless Realm 월드의 공식 무료 브라우저 MMO입니다. 지속 캐릭터로 온라인 플레이를 하거나, 오프라인에서 혼자 탐험하고, 위키를 읽고, 이 사이트에서 검증된 커뮤니티 링크를 확인하세요.',
  ...
  'serverUnavailable.body':
    '게임 서비스를 재시작하고 있으며 Endless Realm은 곧 돌아올 예정입니다. 이 페이지는 자동으로 계속 확인합니다.',
  ...
  'guide.family.golem.desc':
    '돌과 호박으로 빚어진 살아 움직이는 구조물로, 느리지만 짓누를 듯 강하며 자신이 얽매인 장소를 지킨다.',
  ...
  'guide.worldPage.volcanoBlurb':
    '불탄 땅과 잉걸빛 하늘이 펼쳐진 황무지에서 동개울 마을은 굴하지 않고 서 있습니다. 새내기 영웅들은 이곳에서 잿빛 늑대와 산적들 사이에서 생존을 배웁니다.',
  ...
  'guide.worldPage.volcanoGreeter': '레드브룩 원수, 이스트브룩',
  'guide.worldPage.volcanoGreeting': '칼을 가까이 두시오. 상흔지는 예전 같지 않으니.',
  'guide.worldPage.volcanoPlaceNotes':
    '이스트브룩은 여러분의 첫 본거지입니다. 늑대길과 잿빛 멧돼지 벌판은 불탄 사냥터이고, 유리물빛 호수는 광천처럼 따뜻한 수원이지만 얕은 물가에는 진흙지느러미가 우글거립니다. 흑거미줄과 구리 광산에는 거미와 광석에 굶주린 굴착꾼이 숨어 있고, 도적 야영지와 무너진 예배당은 한층 거친 일거리를 품습니다. 성물실 언덕은 왕국 최초의 탐굴인 무너진 성물실로 내려가는 길이고, 잉걸숲은 북쪽의 듬성듬성하고 잉걸빛으로 물든 숲입니다. 그리고 잿벌판은 담장을 두른 이스트브룩의 보어볼 경기장으로, 수확 휴전 아래 베일 컵이 열리는 곳입니다.',
  ...
  'hudChrome.discord.swag.titleChampion': '칭호: Endless Realm의 챔피언',
  ...
  'dashboard.nav.collection': '컬렉션',
  'dashboard.nav.leaderboard': '순위표',
  'dashboard.login.username': '사용자 이름',
  'dashboard.login.password': '비밀번호',
  'dashboard.login.registerPrompt': '계정이 없으신가요?',
  'dashboard.login.registerLink': '계정 만들기',
  'dashboard.login.twoFactorLabel': '6자리 코드 또는 복구 코드',
  'dashboard.login.twoFactorSubmit': '인증',
  'dashboard.register.title': '계정 생성',
  'dashboard.register.email': '이메일',
  'dashboard.register.submit': '계정 생성',
  'dashboard.loggedOut.message': '계정을 보려면 로그인하세요.',
  'dashboard.profile.title': '프로필',
  'dashboard.profile.noCharacters': '아직 캐릭터가 없습니다.',
  'dashboard.collection.title': '컬렉션',
  'dashboard.collection.empty': '아직 획득한 업적이 없습니다.',
  'dashboard.collection.loadMore': '더 보기',
  'dashboard.leaderboard.title': '순위표',
  'dashboard.leaderboard.tabXp': '경험치',
  'dashboard.leaderboard.tabArena': '투기장',
  'dashboard.error.retry': '다시 시도',
  'dashboard.error.generic': '문제가 발생했습니다.',
