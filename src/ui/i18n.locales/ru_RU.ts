...
export const ru_RU: Partial<Record<TranslationKey, string>> = {
  ...
  'hudChrome.wocStore.balance': 'Баланс Credits',
  'hudChrome.wocStore.buyCredits': 'Купить Credits',
  'hudChrome.wocStore.owned': 'Получено',
  'hudChrome.wocStore.needMoreTitle': 'Требуется больше Credits',
  'hudChrome.wocStore.needMoreBody': 'Для покупки {item} не хватает {shortfall} Credits.',
  'hudChrome.wocStore.cancel': 'Отмена',
  'hudChrome.wocStore.confirmTitle': 'Подтвердить покупку облика',
  'hudChrome.wocStore.confirmBody': 'Купить {item} за {cost} Credits?',
  ...
  'hudChrome.credits.title': 'Credits',
  'hudChrome.credits.open': 'Открыть Credits',
  'hudChrome.credits.close': 'Закрыть Credits',
  'hudChrome.credits.loading': 'Загрузка Credits…',
  'hudChrome.credits.balanceLabel': 'Баланс',
  'hudChrome.credits.balanceUnit': '{amount} Credits',
  'hudChrome.credits.unavailable':
    'Магазин Credits сейчас недоступен. Ваш баланс и покупки не затронуты; повторите попытку позже.',
  'hudChrome.credits.disclosure':
    'Credits — односторонняя игровая валюта: её можно купить за деньги и потратить на косметические предметы. Её нельзя вернуть, передать или обналичить.',
  'hudChrome.credits.buyTitle': 'Купить Credits',
  'hudChrome.credits.railLabel': 'Способ оплаты',
  'hudChrome.credits.railNativeUnavailable': 'SOL/WOC недоступны',
  'hudChrome.credits.railSol': 'SOL',
  'hudChrome.credits.railStripe': 'Карта',
  'hudChrome.credits.railWoc': 'WOC',
  'hudChrome.credits.railWocDiscount': 'Скидка 20%',
  'hudChrome.credits.solBalance': 'SOL: {amount}',
  'hudChrome.credits.wocBalance': 'WOC: {amount}',
  'hudChrome.credits.railWocUnavailable': 'Цена WOC сейчас недоступна.',
  'hudChrome.credits.amountLabel': 'Количество',
  'hudChrome.credits.showAmounts': 'Показать все варианты Credits',
  'hudChrome.credits.hideAmounts': 'Скрыть дополнительные варианты Credits',
  'hudChrome.credits.skuRow': '{credits} Credits за {usd}',
  'hudChrome.credits.buyUnavailable': 'Покупки сейчас недоступны.',
  'hudChrome.credits.storeTitle': 'Магазин косметики',
  'hudChrome.credits.storeEmpty': 'Сейчас косметические предметы недоступны.',
  'hudChrome.credits.storeCost': '{amount} Credits',
  'hudChrome.credits.spendButton': 'Обменять',
  'hudChrome.credits.kindCosmetic': 'Косметика',
  'hudChrome.credits.kindItem': 'Предмет',
  'hudChrome.credits.kindSkin': 'Облик',
  'hudChrome.credits.buyButton': 'Купить',
  'hudChrome.credits.checkoutTitle': 'Завершить покупку',
  'hudChrome.credits.checkoutClose': 'Закрыть оплату',
  'hudChrome.credits.checkoutLoading': 'Загрузка оплаты…',
  'hudChrome.credits.checkoutPending':
    'Транзакция выполняется. Подтвердите её в кошельке и не закрывайте эту панель.',
  'hudChrome.credits.checkoutPendingButton': 'Обработка',
  'hudChrome.credits.checkoutFailed': 'Не удалось загрузить оплату. Повторите попытку.',
  'hudChrome.credits.checkoutUnavailable': 'Эта покупка Credits сейчас недоступна.',
  'hudChrome.credits.checkoutWalletRequired':
    'Подключите кошелёк Solana перед покупкой Credits за криптовалюту.',
  ...
  'hudChrome.credits.checkoutNotSettled':
    'Транзакция отправлена, но Credits ещё не зачислен. Повторите попытку позже.',
  ...
  'seo.officialBody':
    'endlessglory.vercel.app - официальная бесплатная браузерная MMO для мира Endless Realm. Играйте онлайн с постоянным персонажем, исследуйте мир в одиночку офлайн, читайте wiki и переходите по проверенным ссылкам сообщества с этого сайта.',
  ...
  'serverUnavailable.body':
    'Мы перезапускаем игровой сервис и ожидаем, что Endless Realm скоро вернется. Эта страница продолжит проверку автоматически.',
  ...
  'guide.worldPage.volcanoBlurb':
    'Выжженная пустошь под тлеющим небом, где город Восточный Брод стоит несломленным. Здесь новые герои учатся выживать среди пепельных волков и разбойников.',
  ...
  'guide.worldPage.volcanoGreeter': 'Маршал Редбрук, Истврук',
  'guide.worldPage.volcanoGreeting': 'Держите клинок наготове. Шрам уже не тот, что прежде.',
  'guide.worldPage.volcanoPlaceNotes':
    'Истврук, ваша первая опорная база. Волчья тропа и Пепельный кабаний выгон, это выжженные охотничьи угодья; Стекловодное озеро, это тёплый минеральный источник, хотя его отмели кишат грязепёрами; Сейблвеб и Медный карьер прячут пауков и жадных до руды землекопов; Лагерь бандитов и Павшая часовня хранят работу погрубее; Холм Реликвария ведёт вниз, в Обрушившийся Реликварий, первую вылазку мира; Поляна Эмберву́да, это редкая роща на севере, окрашенная в тона тлеющих углей; а Пепелище, это обнесённая стенами кабанбольная площадка Истврука, где под жатвенным перемирием разыгрывается Кубок Долины.',
  ...
  'hudChrome.discord.swag.titleChampion': 'Титул: Чемпион Endless Realm',
  ...
  'hudChrome.credits.railUsdc': 'USDC',
  'hudChrome.credits.usdcBalance': 'USDC: {amount}',
  ...
  'dashboard.nav.collection': 'Коллекция',
  'dashboard.nav.leaderboard': 'Таблица лидеров',
  'dashboard.login.username': 'Имя пользователя',
  'dashboard.login.password': 'Пароль',
  'dashboard.login.registerPrompt': 'Нет аккаунта?',
  'dashboard.login.registerLink': 'Создать',
  'dashboard.login.twoFactorLabel': '6-значный код или код восстановления',
  'dashboard.login.twoFactorSubmit': 'Подтвердить',
  'dashboard.register.title': 'Создать аккаунт',
  'dashboard.register.email': 'Эл. почта',
  'dashboard.register.submit': 'Создать аккаунт',
  'dashboard.loggedOut.message': 'Войдите, чтобы увидеть свой аккаунт.',
  'dashboard.profile.title': 'Профиль',
  'dashboard.profile.noCharacters': 'Пока нет персонажей.',
  'dashboard.collection.title': 'Коллекция',
  'dashboard.collection.empty': 'Пока не получено ни одного деяния.',
  'dashboard.collection.loadMore': 'Загрузить еще',
  'dashboard.leaderboard.title': 'Таблица лидеров',
  'dashboard.leaderboard.tabXp': 'Опыт',
  'dashboard.leaderboard.tabArena': 'Арена',
  'dashboard.error.retry': 'Повторить',
  'dashboard.error.generic': 'Произошла ошибка.',
