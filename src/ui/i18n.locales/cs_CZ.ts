...
export const cs_CZ: Partial<Record<TranslationKey, string>> = {
  ...
  'seo.genre': 'MMORPG',
  'seo.officialBody':
    'endlessglory.vercel.app je oficiální bezplatné prohlížečové MMO pro svět Endless Realm. Hraj online s trvalou postavou, prozkoumávej sólo offline, čti wiki a používej ověřené komunitní odkazy z tohoto webu.',
  ...
  'serverUnavailable.body':
    'Restartujeme herní službu a očekáváme, že se Endless Realm brzy vrátí. Tato stránka bude stav automaticky kontrolovat.',
  ...
  'hudChrome.discord.swag.titleChampion': 'Titul: Šampion Endless Realmu',
  ...
  'hudChrome.credits.amountLabel': 'Množství',
  'hudChrome.credits.balanceLabel': 'Zůstatek',
  'hudChrome.credits.balanceUnit': '{amount} Credits',
  'hudChrome.credits.buyButton': 'Koupit',
  'hudChrome.credits.buyTitle': 'Koupit Credits',
  'hudChrome.credits.buyUnavailable': 'Nákup nyní není dostupný.',
  'hudChrome.credits.checkoutClose': 'Zavřít platbu',
  'hudChrome.credits.checkoutFailed': 'Platbu se nepodařilo načíst. Zkus to znovu.',
  'hudChrome.credits.checkoutLoading': 'Načítání platby…',
  'hudChrome.credits.checkoutNotSettled':
    'Transakce byla odeslána, ale Credits zatím nebylo připsáno. Zkus to za chvíli znovu.',
  'hudChrome.credits.checkoutPending':
    'Transakce probíhá. Potvrď ji v peněžence a nech tento panel otevřený.',
  'hudChrome.credits.checkoutPendingButton': 'Zpracovává se',
  'hudChrome.credits.checkoutTitle': 'Dokončit nákup',
  'hudChrome.credits.checkoutUnavailable': 'Tento nákup Credits nyní není dostupný.',
  'hudChrome.credits.checkoutWalletRequired':
    'Před nákupem Credits za kryptoměnu připoj peněženku Solana.',
  'hudChrome.credits.checkoutWalletUnsupported':
    'Tato peněženka neumí podepisovat a odesílat transakce Solana.',
  'hudChrome.credits.close': 'Zavřít Credits',
  'hudChrome.credits.disclosure':
    'Credits je jednosměrná herní měna: kupuje se za peníze a utrácí za kosmetické předměty. Nelze ji směnit zpět, převést ani vyplatit v hotovosti.',
  'hudChrome.credits.hideAmounts': 'Skrýt další nabídky Credits',
  'hudChrome.credits.kindCosmetic': 'Kosmetika',
  'hudChrome.credits.kindItem': 'Předmět',
  'hudChrome.credits.kindSkin': 'Vzhled',
  'hudChrome.credits.loading': 'Načítání Credits…',
  'hudChrome.credits.open': 'Otevřít Credits',
  'hudChrome.credits.railLabel': 'Způsob platby',
  'hudChrome.credits.railNativeUnavailable': 'SOL/WOC nedostupné',
  'hudChrome.credits.railSol': 'SOL',
  'hudChrome.credits.railStripe': 'Karta',
  'hudChrome.credits.railWoc': 'WOC',
  'hudChrome.credits.railWocDiscount': 'Sleva 20 %',
  'hudChrome.credits.railWocUnavailable': 'Cena ve WOC nyní není dostupná.',
  'hudChrome.credits.showAmounts': 'Zobrazit všechny nabídky Credits',
  'hudChrome.credits.skuRow': '{credits} Credits za {usd}',
  'hudChrome.credits.solBalance': 'SOL: {amount}',
  'hudChrome.credits.spendButton': 'Uplatnit',
  'hudChrome.credits.storeCost': '{amount} Credits',
  'hudChrome.credits.storeEmpty': 'Žádná kosmetika nyní není dostupná.',
  'hudChrome.credits.storeTitle': 'Obchod s kosmetikou',
  ...
  'hudChrome.wocStore.balance': 'Zůstatek Credits',
  'hudChrome.wocStore.buyCredits': 'Koupit Credits',
  ...
  'hudChrome.wocStore.confirmBody': 'Koupit {item} za {cost} Credits?',
  ...
  'hudChrome.wocStore.needMoreBody':
    'K nákupu předmětu {item} potřebuješ ještě {shortfall} Credits.',
  'hudChrome.wocStore.needMoreTitle': 'Je potřeba více Credits',
