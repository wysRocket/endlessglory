...
export const sv_SE: Partial<Record<TranslationKey, string>> = {
  ...
  'seo.genre': 'MMORPG',
  'seo.officialBody':
    'endlessglory.vercel.app är den officiella gratis webbläsar-MMO:n för Endless Realm-världen. Spela online med en beständig karaktär, utforska solo offline, läs wikin och följ verifierade gemenskapslänkar från den här webbplatsen.',
  ...
  'serverUnavailable.body':
    'Vi startar om speltjänsten och förväntar oss att Endless Realm är tillbaka inom kort. Den här sidan fortsätter att kontrollera automatiskt.',
  ...
  'hudChrome.discord.swag.titleChampion': 'Titel: Champion of Endless Realm',
  ...
  'hudChrome.credits.amountLabel': 'Belopp',
  'hudChrome.credits.balanceLabel': 'Saldo',
  'hudChrome.credits.balanceUnit': '{amount} Credits',
  'hudChrome.credits.buyButton': 'Köp',
  'hudChrome.credits.buyTitle': 'Köp Credits',
  'hudChrome.credits.buyUnavailable': 'Det går inte att genomföra köp just nu.',
  'hudChrome.credits.checkoutClose': 'Stäng betalningsfönstret',
  'hudChrome.credits.checkoutFailed': 'Det gick inte att ladda kassan. Försök igen.',
  'hudChrome.credits.checkoutLoading': 'Laddar kassan...',
  'hudChrome.credits.checkoutNotSettled':
    'Transaktionen skickades men Credits har inte krediterats ännu. Försök snart igen.',
  'hudChrome.credits.checkoutPending':
    'Transaktion pågår. Bekräfta i din plånbok och håll denna panel öppen.',
  'hudChrome.credits.checkoutPendingButton': 'Bearbetar',
  'hudChrome.credits.checkoutTitle': 'Slutför köp',
  'hudChrome.credits.checkoutUnavailable': 'Det Credits-köpet är inte tillgängligt just nu.',
  'hudChrome.credits.checkoutWalletRequired':
    'Anslut en Solana-plånbok innan du köper Credits med krypto.',
  'hudChrome.credits.checkoutWalletUnsupported':
    'Denna plånbok kan inte signera och skicka Solana-transaktioner.',
  'hudChrome.credits.close': 'Stäng Credits',
  'hudChrome.credits.disclosure':
    'Credits är en virtuell valuta som bara går åt ett håll: köp den för pengar och använd den till kosmetika. Den kan inte växlas in, överföras eller betalas ut.',
  'hudChrome.credits.hideAmounts': 'Dölj extra Credits-belopp',
  'hudChrome.credits.kindCosmetic': 'Kosmetisk',
  'hudChrome.credits.kindItem': 'Föremål',
  'hudChrome.credits.kindSkin': 'Skin',
  'hudChrome.credits.loading': 'Laddar Credits...',
  'hudChrome.credits.open': 'Öppna Credits',
  'hudChrome.credits.railLabel': 'Betalningsmetod',
  'hudChrome.credits.railNativeUnavailable': 'SOL/WOC är avstängt.',
  'hudChrome.credits.railSol': 'SOL',
  'hudChrome.credits.railStripe': 'Kort',
  'hudChrome.credits.railWoc': 'WOC',
  'hudChrome.credits.railWocDiscount': '20% rabatt',
  'hudChrome.credits.railWocUnavailable': 'WOC-priser är inte tillgängliga just nu.',
  'hudChrome.credits.showAmounts': 'Visa alla Credits-belopp',
  'hudChrome.credits.skuRow': '{usd} för {credits} Credits',
  'hudChrome.credits.solBalance': 'SOL: {amount}',
  'hudChrome.credits.spendButton': 'Lös in',
  'hudChrome.credits.storeCost': '{amount} Credits',
  'hudChrome.credits.storeEmpty': 'Inga kosmetika är tillgängliga just nu.',
  'hudChrome.credits.storeTitle': 'Kosmetisk butik',
  'hudChrome.credits.title': 'Credits',
  'hudChrome.credits.unavailable':
    'Credits-butiken är inte tillgänglig just nu. Ditt saldo och dina köp påverkas inte. Försök igen om en stund.',
  ...
  'hudChrome.wocStore.balance': 'Credits-saldo',
  'hudChrome.wocStore.buyCredits': 'Köp Credits',
  ...
  'hudChrome.wocStore.confirmBody': 'Köpa {item} för {cost} Credits?',
  ...
  'hudChrome.wocStore.needMoreBody': 'Du behöver {shortfall} mer Credits för att köpa {item}.',
  'hudChrome.wocStore.needMoreTitle': 'Mer Credits krävs',
