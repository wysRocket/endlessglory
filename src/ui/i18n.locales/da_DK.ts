...
export const da_DK: Partial<Record<TranslationKey, string>> = {
  ...
  'seo.genre': 'MMORPG',
  'seo.officialBody':
    'endlessglory.vercel.app er den officielle gratis browser-MMO for Endless Realm-verdenen. Spil online med en vedvarende karakter, udforsk solo offline, læs wikien, og følg verificerede fællesskabslinks fra denne side.',
  ...
  'serverUnavailable.body':
    'Vi genstarter spiltjenesten og forventer, at Endless Realm vender tilbage om kort tid. Denne side bliver ved med at tjekke automatisk.',
  ...
  'hudChrome.discord.swag.titleChampion': 'Titel: Champion af Endless Realm',
  ...
  'hudChrome.credits.amountLabel': 'Beløb',
  'hudChrome.credits.balanceLabel': 'Saldo',
  'hudChrome.credits.balanceUnit': '{amount} Credits',
  'hudChrome.credits.buyButton': 'Køb',
  'hudChrome.credits.buyTitle': 'Køb Credits',
  'hudChrome.credits.buyUnavailable': 'Det er ikke muligt at foretage køb lige nu.',
  'hudChrome.credits.checkoutClose': 'Luk betalingsvinduet',
  'hudChrome.credits.checkoutFailed': 'Betalingsvinduet kunne ikke indlæses. Prøv igen.',
  'hudChrome.credits.checkoutLoading': 'Indlæser betalingsvinduet...',
  'hudChrome.credits.checkoutNotSettled':
    'Transaktionen blev sendt, men Credits er endnu ikke blevet tilføjet. Prøv igen om lidt.',
  'hudChrome.credits.checkoutPending':
    'Transaktion i gang. Bekræft i din tegnebog, og hold dette panel åbent.',
  'hudChrome.credits.checkoutPendingButton': 'Behandler',
  'hudChrome.credits.checkoutTitle': 'Gennemfør køb',
  'hudChrome.credits.checkoutUnavailable': 'Dette Credits-køb er ikke tilgængeligt lige nu.',
  'hudChrome.credits.checkoutWalletRequired':
    'Tilslut en Solana-tegnebog, før du køber Credits med kryptovaluta.',
  'hudChrome.credits.checkoutWalletUnsupported':
    'Denne tegnebog kan ikke underskrive og sende Solana-transaktioner.',
  'hudChrome.credits.close': 'Luk Credits',
  'hudChrome.credits.disclosure':
    'Credits er en virtuel valuta, der kun går én vej: Køb den for penge, og brug den på kosmetik. Den kan ikke indløses, overføres eller udbetales.',
  'hudChrome.credits.hideAmounts': 'Skjul ekstra Credits-beløb',
  'hudChrome.credits.kindCosmetic': 'Kosmetisk',
  'hudChrome.credits.kindItem': 'Genstand',
  'hudChrome.credits.kindSkin': 'Skin',
  'hudChrome.credits.loading': 'Indlæser Credits...',
  'hudChrome.credits.open': 'Åbn Credits',
  'hudChrome.credits.railLabel': 'Betalingsmetode',
  'hudChrome.credits.railNativeUnavailable': 'SOL/WOC er slået fra.',
  'hudChrome.credits.railSol': 'SOL',
  'hudChrome.credits.railStripe': 'Kort',
  'hudChrome.credits.railWoc': 'WOC',
  'hudChrome.credits.railWocDiscount': '20% rabat',
  'hudChrome.credits.railWocUnavailable': 'WOC-priser er ikke tilgængelige lige nu.',
  'hudChrome.credits.showAmounts': 'Vis alle Credits-beløb',
  'hudChrome.credits.skuRow': '{usd} til {credits} Credits',
  'hudChrome.credits.solBalance': 'SOL: {amount}',
  'hudChrome.credits.spendButton': 'Brug',
  'hudChrome.credits.storeCost': '{amount} Credits',
  'hudChrome.credits.storeEmpty': 'Ingen kosmetik er tilgængelig lige nu.',
  ...
  'hudChrome.wocStore.buyCredits': 'Køb Credits',
  ...
  'hudChrome.wocStore.confirmBody': 'Køb {item} til {cost} Credits?',
  ...
  'hudChrome.wocStore.needMoreBody': 'Du skal bruge {shortfall} mere Credits for at købe {item}.',
  'hudChrome.wocStore.needMoreTitle': 'Mere Credits påkrævet',
