...
export const tr_TR: Partial<Record<TranslationKey, string>> = {
  ...
  'seo.genre': 'MMORPG',
  'seo.officialBody':
    "endlessglory.vercel.app, Endless Realm dünyasının resmi ücretsiz tarayıcı MMO'sudur. Kalıcı bir karakterle çevrimiçi oyna, çevrimdışı tek başına keşfet, wiki'yi oku ve bu siteden doğrulanmış topluluk bağlantılarını takip et.",
  ...
  'serverUnavailable.body':
    "Oyun hizmetini yeniden başlatıyoruz ve Endless Realm'un kısa süre içinde geri döneceğini umuyoruz. Bu sayfa otomatik olarak denetlemeye devam edecek.",
  ...
  'hudChrome.discord.swag.titleChampion': 'Unvan: Endless Realm Şampiyonu',
  ...
  'hudChrome.credits.amountLabel': 'Miktar',
  'hudChrome.credits.balanceLabel': 'Bakiye',
  'hudChrome.credits.balanceUnit': '{amount} Credits',
  'hudChrome.credits.buyButton': 'Satın Al',
  'hudChrome.credits.buyTitle': "Credits'u satın al",
  'hudChrome.credits.buyUnavailable': 'Şu anda satın alma işlemi yapılamıyor.',
  'hudChrome.credits.checkoutClose': 'Ödemeyi kapat',
  'hudChrome.credits.checkoutFailed': 'Ödeme yüklenemedi. Lütfen tekrar deneyin.',
  'hudChrome.credits.checkoutLoading': 'Ödeme yükleniyor...',
  'hudChrome.credits.checkoutNotSettled':
    "İşlem gönderildi ancak Credits'a henüz para yatırılmadı. Lütfen kısa süre sonra tekrar deneyin.",
  'hudChrome.credits.checkoutPending':
    'İşlem devam ediyor. Cüzdanınızda onaylayın ve bu paneli açık tutun.',
  'hudChrome.credits.checkoutPendingButton': 'İşleme',
  'hudChrome.credits.checkoutTitle': 'Satın alma işlemini tamamla',
  'hudChrome.credits.checkoutUnavailable': 'Bu Credits satın alımı şu anda mevcut değil.',
  'hudChrome.credits.checkoutWalletRequired':
    "Credits'u kriptoyla satın almadan önce bir Solana cüzdanı bağlayın.",
  'hudChrome.credits.checkoutWalletUnsupported':
    'Bu cüzdan Solana işlemlerini imzalayamaz ve gönderemez.',
  'hudChrome.credits.close': "Credits'u kapat",
  'hudChrome.credits.disclosure':
    'Credits tek yönlü yumuşak bir para birimidir: Parayla satın alın ve kozmetik ürünlerine harcayın. Kullanılamaz, devredilemez veya nakde çevrilemez.',
  'hudChrome.credits.hideAmounts': 'Ekstra Credits miktarlarını gizle',
  'hudChrome.credits.kindCosmetic': 'Kozmetik',
  'hudChrome.credits.kindItem': 'Öğe',
  'hudChrome.credits.kindSkin': 'Görünüm',
  'hudChrome.credits.loading': 'Credits yükleniyor...',
  'hudChrome.credits.open': "Credits'u aç",
  'hudChrome.credits.railLabel': 'Ödeme yöntemi',
  'hudChrome.credits.railNativeUnavailable': 'SOL/WOC şu anda kullanılamıyor.',
  'hudChrome.credits.railSol': 'SOL',
  'hudChrome.credits.railStripe': 'Kart',
  'hudChrome.credits.railWoc': 'WOC',
  'hudChrome.credits.railWocDiscount': '%20 indirim',
  'hudChrome.credits.railWocUnavailable': 'WOC fiyatlandırması şu anda mevcut değil.',
  'hudChrome.credits.showAmounts': 'Tüm Credits miktarlarını göster',
  'hudChrome.credits.skuRow': '{credits} Credits için {usd}',
  'hudChrome.credits.solBalance': 'SOL: {amount}',
  'hudChrome.credits.spendButton': 'Kullan',
  'hudChrome.credits.storeCost': '{amount} Credits',
  'hudChrome.credits.storeEmpty': 'Şu anda kozmetik mevcut değil.',
  'hudChrome.credits.storeTitle': 'Kozmetik Mağazası',
  ...
  'hudChrome.wocStore.balance': 'Credits Bakiyesi',
  'hudChrome.wocStore.buyCredits': "Credits'u satın al",
  ...
  'hudChrome.wocStore.confirmBody': '{cost} Credits için {item} satın alınsın mı?',
  ...
  'hudChrome.wocStore.needMoreBody':
    "{item} satın almak için {shortfall} daha fazla Credits'a ihtiyacınız var.",
  'hudChrome.wocStore.needMoreTitle': 'Daha Fazla Credits Gerekli',
