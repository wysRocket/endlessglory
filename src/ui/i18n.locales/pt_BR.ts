...
export const pt_BR: Partial<Record<TranslationKey, string>> = {
  ...
  'seo.officialBody':
    'endlessglory.vercel.app é o MMO de navegador gratuito oficial do mundo Endless Realm. Jogue online com um personagem persistente, explore solo offline, leia a wiki e siga os links verificados da comunidade a partir deste site.',
  ...
  'serverUnavailable.body':
    'Estamos reiniciando o serviço do jogo e esperamos que Endless Realm volte em breve. Esta página continuará verificando automaticamente.',
  ...
  'hudChrome.discord.swag.titleChampion': 'Título: Campeão de Endless Realm',
  ...
  'hudChrome.credits.amountLabel': 'Quantia',
  ...
  'hudChrome.credits.buyUnavailable': 'A compra não está disponível no momento.',
  'hudChrome.credits.checkoutClose': 'Fechar checkout',
  'hudChrome.credits.checkoutFailed':
    'Não foi possível carregar a finalização da compra. Tente novamente.',
  'hudChrome.credits.checkoutLoading': 'Carregando finalização da compra...',
  'hudChrome.credits.checkoutNotSettled':
    'A transação foi enviada, mas Credits ainda não foi creditado. Tente novamente em breve.',
  'hudChrome.credits.checkoutPending':
    'Transação em andamento. Confirme na sua carteira e mantenha este painel aberto.',
  'hudChrome.credits.checkoutPendingButton': 'Processando',
  'hudChrome.credits.checkoutTitle': 'Concluir compra',
  'hudChrome.credits.checkoutUnavailable': 'Essa compra do Credits não está disponível no momento.',
  'hudChrome.credits.checkoutWalletRequired':
    'Conecte uma carteira Solana antes de comprar Credits com criptomoedas.',
  'hudChrome.credits.checkoutWalletUnsupported':
    'Esta carteira não pode assinar e enviar transações Solana.',
  'hudChrome.credits.close': 'Fechar Credits',
  'hudChrome.credits.disclosure':
    'Credits é uma moeda virtual de mão única: compre-a com dinheiro real e gaste-a em cosméticos. Ela não pode ser resgatada, transferida nem convertida em dinheiro.',
  'hudChrome.credits.hideAmounts': 'Ocultar valores extras de Credits',
  'hudChrome.credits.kindCosmetic': 'Cosmético',
  'hudChrome.credits.kindItem': 'Item',
  'hudChrome.credits.kindSkin': 'Visual',
  'hudChrome.credits.loading': 'Carregando Credits...',
  'hudChrome.credits.open': 'Abrir Credits',
  'hudChrome.credits.railLabel': 'Forma de pagamento',
  'hudChrome.credits.railNativeUnavailable': 'SOL/WOC indisponível.',
  'hudChrome.credits.railSol': 'SOL',
  'hudChrome.credits.railStripe': 'Cartão',
  'hudChrome.credits.railWoc': 'WOC',
  'hudChrome.credits.railWocDiscount': '20% de desconto',
  'hudChrome.credits.railWocUnavailable': 'O preço do WOC não está disponível no momento.',
  'hudChrome.credits.showAmounts': 'Mostrar todos os valores de Credits',
  'hudChrome.credits.skuRow': '{credits} Credits por {usd}',
  'hudChrome.credits.solBalance': 'SOL: {amount}',
  'hudChrome.credits.spendButton': 'Resgatar',
  'hudChrome.credits.storeCost': '{amount} Credits',
  'hudChrome.credits.storeEmpty': 'Nenhum cosmético está disponível no momento.',
  'hudChrome.credits.storeTitle': 'Loja de cosméticos',
  ...
  'hudChrome.wocStore.needMoreBody':
    'Você precisa de mais {shortfall} Credits para comprar {item}.',
  'hudChrome.wocStore.needMoreTitle': 'Mais Credits necessário',
  ...
  'hudChrome.credits.usdcBalance': 'Saldo em USDC: {amount}',
