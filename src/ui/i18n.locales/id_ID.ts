...
export const id_ID: Partial<Record<TranslationKey, string>> = {
  ...
  'seo.genre': 'MMORPG',
  'seo.officialBody':
    'endlessglory.vercel.app adalah MMO peramban gratis resmi untuk dunia Endless Realm. Bermain daring dengan karakter yang persisten, jelajahi solo secara luring, baca wiki, dan ikuti tautan komunitas terverifikasi dari situs ini.',
  ...
  'serverUnavailable.body':
    'Kami sedang memulai ulang layanan game dan memperkirakan Endless Realm akan kembali sebentar lagi. Halaman ini akan terus memeriksa secara otomatis.',
  ...
  'hudChrome.discord.swag.titleChampion': 'Gelar: Jawara Endless Realm',
  ...
  'hudChrome.credits.amountLabel': 'Jumlah',
  'hudChrome.credits.balanceLabel': 'Saldo',
  'hudChrome.credits.balanceUnit': '{amount} Credits',
  'hudChrome.credits.buyButton': 'Beli',
  'hudChrome.credits.buyTitle': 'Beli Credits',
  'hudChrome.credits.buyUnavailable': 'Pembelian tidak tersedia saat ini.',
  'hudChrome.credits.checkoutClose': 'Tutup pembayaran',
  'hudChrome.credits.checkoutFailed': 'Pembayaran tidak dapat dimuat. Silakan coba lagi.',
  'hudChrome.credits.checkoutLoading': 'Memuat pembayaran...',
  'hudChrome.credits.checkoutNotSettled':
    'Transaksi sudah terkirim tetapi Credits belum dikreditkan. Silakan coba lagi sebentar lagi.',
  ...
  'hudChrome.credits.checkoutPendingButton': 'Diproses',
  'hudChrome.credits.checkoutTitle': 'Selesaikan pembelian',
  'hudChrome.credits.checkoutUnavailable': 'Pembelian Credits tersebut tidak tersedia saat ini.',
  'hudChrome.credits.checkoutWalletRequired':
    'Hubungkan dompet Solana sebelum membeli Credits dengan kripto.',
  'hudChrome.credits.checkoutWalletUnsupported':
    'Dompet ini tidak dapat menandatangani dan mengirim transaksi Solana.',
  'hudChrome.credits.close': 'Tutup Credits',
  'hudChrome.credits.disclosure':
    'Credits adalah mata uang lunak satu arah: beli dengan uang dan belanjakan untuk kosmetik. Itu tidak dapat ditebus, ditransfer, atau diuangkan.',
  'hudChrome.credits.hideAmounts': 'Sembunyikan jumlah Credits tambahan',
  'hudChrome.credits.kindCosmetic': 'Kosmetik',
  'hudChrome.credits.kindItem': 'Barang',
  'hudChrome.credits.kindSkin': 'Tampilan',
  'hudChrome.credits.loading': 'Memuat Credits...',
  'hudChrome.credits.open': 'Buka Credits',
  'hudChrome.credits.railLabel': 'Metode pembayaran',
  'hudChrome.credits.railNativeUnavailable': 'SOL/WOC tidak tersedia.',
  'hudChrome.credits.railSol': 'SOL',
  'hudChrome.credits.railStripe': 'Kartu',
  'hudChrome.credits.railWoc': 'WOC',
  'hudChrome.credits.railWocDiscount': 'Diskon 20%.',
  'hudChrome.credits.railWocUnavailable': 'Harga WOC tidak tersedia saat ini.',
  'hudChrome.credits.showAmounts': 'Tampilkan semua jumlah Credits',
  'hudChrome.credits.skuRow': '{usd} untuk {credits} Credits',
  'hudChrome.credits.solBalance': 'SOL: {amount}',
  'hudChrome.credits.spendButton': 'Tukar',
  'hudChrome.credits.storeCost': '{amount} Credits',
  'hudChrome.credits.storeEmpty': 'Tidak ada kosmetik yang tersedia saat ini.',
  'hudChrome.credits.storeTitle': 'Toko Kosmetik',
  ...
  'hudChrome.wocStore.buyCredits': 'Beli Credits',
  ...
  'hudChrome.wocStore.confirmBody': 'Beli {item} untuk {cost} Credits?',
  ...
  'hudChrome.wocStore.needMoreBody':
    'Anda memerlukan {shortfall} lebih banyak Credits untuk membeli {item}.',
  'hudChrome.wocStore.needMoreTitle': 'Dibutuhkan Lebih Banyak Credits',
