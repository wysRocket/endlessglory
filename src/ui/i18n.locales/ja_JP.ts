...
export const ja_JP: Partial<Record<TranslationKey, string>> = {
  ...
  'hudChrome.wocStore.balance': 'Credits残高',
  'hudChrome.wocStore.buyCredits': 'Creditsを購入',
  'hudChrome.wocStore.owned': '所有済み',
  'hudChrome.wocStore.needMoreTitle': 'Creditsが不足しています',
  'hudChrome.wocStore.needMoreBody': '{item}の購入にはあと{shortfall} Credits必要です。',
  'hudChrome.wocStore.cancel': 'キャンセル',
  'hudChrome.wocStore.confirmTitle': '外見の購入を確認',
  'hudChrome.wocStore.confirmBody': '{item}を{cost} Creditsで購入しますか？',
  ...
  'hudChrome.credits.open': 'Creditsを開く',
  'hudChrome.credits.close': 'Creditsを閉じる',
  'hudChrome.credits.loading': 'Creditsを読み込み中…',
  'hudChrome.credits.balanceLabel': '残高',
  'hudChrome.credits.balanceUnit': '{amount} Credits',
  'hudChrome.credits.unavailable':
    'Creditsストアは現在利用できません。残高と購入内容に影響はありません。しばらくしてからお試しください。',
  'hudChrome.credits.disclosure':
    'Creditsは一方向のゲーム内通貨です。現金で購入して外見アイテムに使用でき、換金、譲渡、払い戻しはできません。',
  'hudChrome.credits.buyTitle': 'Creditsを購入',
  'hudChrome.credits.railLabel': '支払い方法',
  'hudChrome.credits.railNativeUnavailable': 'SOL/WOCは利用不可',
  'hudChrome.credits.railSol': 'SOL',
  'hudChrome.credits.railStripe': 'カード',
  'hudChrome.credits.railWoc': 'WOC',
  'hudChrome.credits.railWocDiscount': '20%オフ',
  'hudChrome.credits.solBalance': 'SOL：{amount}',
  'hudChrome.credits.wocBalance': 'WOC：{amount}',
  'hudChrome.credits.railWocUnavailable': 'WOC価格は現在利用できません。',
  'hudChrome.credits.amountLabel': '数量',
  'hudChrome.credits.showAmounts': 'すべてのCredits数量を表示',
  'hudChrome.credits.hideAmounts': '追加のCredits数量を隠す',
  'hudChrome.credits.skuRow': '{usd}で{credits} Credits',
  'hudChrome.credits.buyUnavailable': '現在購入できません。',
  'hudChrome.credits.storeTitle': '外見アイテムストア',
  'hudChrome.credits.storeEmpty': '現在利用できる外見アイテムはありません。',
  'hudChrome.credits.storeCost': '{amount} Credits',
  'hudChrome.credits.spendButton': '交換',
  'hudChrome.credits.kindCosmetic': '外見アイテム',
  'hudChrome.credits.kindItem': 'アイテム',
  'hudChrome.credits.kindSkin': 'スキン',
  'hudChrome.credits.buyButton': '購入',
  'hudChrome.credits.checkoutTitle': '購入を完了',
  'hudChrome.credits.checkoutClose': '決済を閉じる',
  'hudChrome.credits.checkoutLoading': '決済を読み込み中…',
  'hudChrome.credits.checkoutPending':
    '取引を処理中です。ウォレットで確認し、このパネルを開いたままにしてください。',
  'hudChrome.credits.checkoutPendingButton': '処理中',
  'hudChrome.credits.checkoutFailed': '決済を読み込めませんでした。もう一度お試しください。',
  'hudChrome.credits.checkoutUnavailable': 'そのCredits購入は現在利用できません。',
  'hudChrome.credits.checkoutWalletRequired':
    '暗号資産でCreditsを購入する前にSolanaウォレットを接続してください。',
  'hudChrome.credits.checkoutWalletUnsupported':
    'このウォレットではSolana取引の署名と送信ができません。',
  'hudChrome.credits.checkoutNotSettled':
    '取引は送信されましたが、Creditsはまだ反映されていません。しばらくしてからお試しください。',
  ...
  'guide.worldPage.volcanoBlurb':
    '焼け焦げた大地と灰燼の空が広がる荒野で、イーストブルックは屈することなく立っています。新たな英雄たちは、ここで灰色のオオカミや盗賊を相手に生き延びる術を学びます。',
  ...
  'guide.worldPage.volcanoGreeter': 'レッドブルック元帥、イーストブルック',
  'guide.worldPage.volcanoGreeting': '刃を手放すな。爪痕の地はかつての姿ではない。',
  'guide.worldPage.volcanoPlaceNotes':
    'イーストブルックは最初の本拠地です。狼の道と灰の猪原は焼け焦げた狩り場、硝子水の湖は鉱泉のように温かい水場ですが、浅瀬にはマッドフィンが群れています。セイブルウェブと銅鉱山には蜘蛛と鉱石に貪欲な掘り手が隠れ、盗賊の野営地と倒れた礼拝堂にはより手荒い仕事があります。聖遺物庫の丘はレルム初のデルヴ、崩れた聖遺物庫へと落ち込み、エンバーウッドの林間は北にあるまばらな、燠火色に染まった木立です。そしてシンダーフィールドはイーストブルックの壁に囲まれたボアボール場で、収穫休戦のもとヴェイルカップが行われます。',
  ...
  'dashboard.nav.collection': 'コレクション',
  'dashboard.nav.leaderboard': 'ランキング',
  'dashboard.login.username': 'ユーザー名',
  'dashboard.login.password': 'パスワード',
  'dashboard.login.registerPrompt': 'アカウントをお持ちでない方は',
  'dashboard.login.registerLink': '新規作成',
  'dashboard.login.twoFactorLabel': '6桁のコードまたは復旧コード',
  'dashboard.login.twoFactorSubmit': '認証',
  'dashboard.register.title': 'アカウント作成',
  'dashboard.register.email': 'メールアドレス',
  'dashboard.register.submit': 'アカウントを作成',
  'dashboard.loggedOut.message': 'アカウントを表示するにはログインしてください。',
  'dashboard.profile.title': 'プロフィール',
  'dashboard.profile.noCharacters': 'キャラクターがまだいません。',
  'dashboard.collection.title': 'コレクション',
  'dashboard.collection.empty': 'まだ功績を獲得していません。',
  'dashboard.collection.loadMore': 'さらに読み込む',
  'dashboard.leaderboard.title': 'ランキング',
  'dashboard.leaderboard.tabXp': '経験値',
  'dashboard.leaderboard.tabArena': 'アリーナ',
  'dashboard.error.retry': '再試行',
  'dashboard.error.generic': 'エラーが発生しました。',
};
