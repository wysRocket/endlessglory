...
export const pl_PL: Partial<Record<TranslationKey, string>> = {
  ...
  'seo.genre': 'MMORPG',
  'seo.officialBody':
    'endlessglory.vercel.app to oficjalne, darmowe przeglądarkowe MMO dla świata Endless Realm. Graj online z trwałą postacią, eksploruj solo w trybie offline, czytaj wiki i śledź zweryfikowane linki społeczności z tej strony.',
  ...
  'serverUnavailable.body':
    'Ponownie uruchamiamy usługę gry i spodziewamy się, że Endless Realm wkrótce wróci. Ta strona będzie automatycznie sprawdzać stan.',
  ...
  'hudChrome.discord.swag.titleChampion': 'Tytuł: Mistrz Endless Realm',
  ...
  'hudChrome.credits.amountLabel': 'Kwota',
  'hudChrome.credits.balanceLabel': 'Saldo',
  'hudChrome.credits.balanceUnit': '{amount} Klaudium',
  'hudChrome.credits.buyButton': 'Kup',
  'hudChrome.credits.buyTitle': 'Kup Credits',
  'hudChrome.credits.buyUnavailable': 'Zakupy są obecnie niedostępne.',
  'hudChrome.credits.checkoutClose': 'Zamknij kasę',
  'hudChrome.credits.checkoutFailed': 'Nie udało się wczytać kasy. Spróbuj ponownie.',
  'hudChrome.credits.checkoutLoading': 'Ładowanie kasy...',
  'hudChrome.credits.checkoutNotSettled':
    'Transakcja została wysłana, ale Credits nie zostało jeszcze zaksięgowane. Spróbuj ponownie wkrótce.',
  'hudChrome.credits.checkoutPending':
    'Transakcja w toku. Potwierdź w swoim portfelu i nie zamykaj tego panelu.',
  'hudChrome.credits.checkoutPendingButton': 'Przetwarzanie',
  'hudChrome.credits.checkoutTitle': 'Dokonaj zakupu',
  'hudChrome.credits.checkoutUnavailable': 'Ten zakup Credits nie jest obecnie dostępny.',
  'hudChrome.credits.checkoutWalletRequired':
    'Podłącz portfel Solana przed zakupem Credits za kryptowalutę.',
  'hudChrome.credits.checkoutWalletUnsupported':
    'Ten portfel nie może podpisywać i wysyłać transakcji Solana.',
  'hudChrome.credits.close': 'Zamknij Klaudium',
  'hudChrome.credits.disclosure':
    'Credits to jednokierunkowa miękka waluta: kup ją za pieniądze i wydawaj na kosmetyki. Nie można go wymienić, przenieść ani wypłacić.',
  'hudChrome.credits.hideAmounts': 'Ukryj dodatkowe ilości Credits',
  'hudChrome.credits.kindCosmetic': 'Kosmetyk',
  'hudChrome.credits.kindItem': 'Przedmiot',
  'hudChrome.credits.kindSkin': 'Skórka',
  'hudChrome.credits.loading': 'Ładowanie Credits...',
  'hudChrome.credits.open': 'Otwórz Klaudium',
  'hudChrome.credits.railLabel': 'Metoda płatności',
  'hudChrome.credits.railNativeUnavailable': 'SOL/WOC są obecnie niedostępne.',
  'hudChrome.credits.railSol': 'SOL',
  'hudChrome.credits.railStripe': 'Karta',
  'hudChrome.credits.railWoc': 'WOC',
  'hudChrome.credits.railWocDiscount': '20% zniżki',
  'hudChrome.credits.railWocUnavailable': 'Ceny WOC są obecnie niedostępne.',
  'hudChrome.credits.showAmounts': 'Pokaż wszystkie ilości Credits',
  'hudChrome.credits.skuRow': '{usd} dla {credits} Credits',
  'hudChrome.credits.solBalance': 'SOL: {amount}',
  'hudChrome.credits.spendButton': 'Wymień',
  'hudChrome.credits.storeCost': '{amount} Klaudium',
  'hudChrome.credits.storeEmpty': 'W tej chwili nie ma żadnych kosmetyków.',
  'hudChrome.credits.storeTitle': 'Sklep kosmetyczny',
  'hudChrome.credits.title': 'Klaudium',
  'hudChrome.credits.unavailable':
    'Sklep Credits jest obecnie niedostępny. Nie ma to wpływu na Twoje saldo i zakupy; sprawdź ponownie wkrótce.',
  ...
  'hudChrome.wocStore.buyCredits': 'Kup Credits',
  ...
  'hudChrome.wocStore.confirmBody': 'Kupić {item} za {cost} Credits?',
  ...
  'hudChrome.wocStore.needMoreBody': 'Potrzebujesz {shortfall} więcej Credits, aby kupić {item}.',
  'hudChrome.wocStore.needMoreTitle': 'Potrzeba więcej Credits',
