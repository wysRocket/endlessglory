...
export const fr_FR: Partial<Record<TranslationKey, string>> = {
  ...
  'hudChrome.credits.amountLabel': 'Montant',
  'hudChrome.credits.balanceLabel': 'Solde',
  'hudChrome.credits.balanceUnit': '{amount} Credits',
  'hudChrome.credits.buyButton': 'Acheter',
  'hudChrome.credits.buyTitle': 'Acheter du Credits',
  'hudChrome.credits.buyUnavailable': 'Les achats sont indisponibles pour le moment.',
  'hudChrome.credits.checkoutClose': 'Fermer le paiement',
  'hudChrome.credits.checkoutFailed': 'Impossible de charger le paiement. Veuillez réessayer.',
  'hudChrome.credits.checkoutLoading': 'Chargement du paiement...',
  'hudChrome.credits.checkoutNotSettled':
    'La transaction a été envoyée, mais le Credits n’a pas encore été crédité. Veuillez réessayer dans quelques instants.',
  'hudChrome.credits.checkoutPending':
    'Transaction en cours. Confirmez-la dans votre portefeuille et gardez ce panneau ouvert.',
  'hudChrome.credits.checkoutPendingButton': 'Traitement en cours',
  'hudChrome.credits.checkoutTitle': 'Finaliser l’achat',
  'hudChrome.credits.checkoutUnavailable': 'Cet achat de Credits est indisponible pour le moment.',
  'hudChrome.credits.checkoutWalletRequired':
    'Connectez un portefeuille Solana avant d’acheter du Credits avec des cryptomonnaies.',
  'hudChrome.credits.checkoutWalletUnsupported':
    'Ce portefeuille ne peut ni signer ni envoyer de transactions Solana.',
  'hudChrome.credits.close': 'Fermer le Credits',
  'hudChrome.credits.disclosure':
    'Le Credits est une monnaie virtuelle à sens unique : achetez-en avec de l’argent et dépensez-le en objets cosmétiques. Il ne peut être ni remboursé, ni transféré, ni converti en argent.',
  'hudChrome.credits.hideAmounts': 'Masquer les montants de Credits supplémentaires',
  'hudChrome.credits.kindCosmetic': 'Objet cosmétique',
  'hudChrome.credits.kindItem': 'Objet',
  'hudChrome.credits.kindSkin': 'Apparence',
  'hudChrome.credits.loading': 'Chargement du Credits...',
  'hudChrome.credits.open': 'Ouvrir le Credits',
  'hudChrome.credits.railLabel': 'Mode de paiement',
  'hudChrome.credits.railNativeUnavailable': 'SOL/WOC désactivé.',
  'hudChrome.credits.railSol': 'SOL',
  'hudChrome.credits.railStripe': 'Carte',
  'hudChrome.credits.railWoc': 'WOC',
  'hudChrome.credits.railWocDiscount': '20 % de réduction',
  'hudChrome.credits.railWocUnavailable': 'Les prix en WOC sont indisponibles pour le moment.',
  'hudChrome.credits.showAmounts': 'Afficher tous les montants de Credits',
  'hudChrome.credits.skuRow': '{credits} Credits pour {usd}',
  'hudChrome.credits.solBalance': 'SOL : {amount}',
  'hudChrome.credits.spendButton': 'Échanger',
  'hudChrome.credits.storeCost': '{amount} Credits',
  'hudChrome.credits.storeEmpty': 'Aucun objet cosmétique n’est disponible pour le moment.',
  'hudChrome.credits.storeTitle': 'Boutique d’objets cosmétiques',
  ...
  'hudChrome.wocStore.balance': 'Solde de Credits',
  'hudChrome.wocStore.buyCredits': 'Acheter du Credits',
  ...
  'hudChrome.wocStore.confirmBody': 'Acheter {item} pour {cost} Credits ?',
  ...
  'hudChrome.wocStore.needMoreBody': 'Il vous faut encore {shortfall} Credits pour acheter {item}.',
  'hudChrome.wocStore.needMoreTitle': 'Credits supplémentaire requis',
