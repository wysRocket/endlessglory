...
export const sv_SE: EnTranslations = {
  ...
  "hudChrome": {
    ...
    "wocStore": {
      ...
      "balance": "Credits-saldo",
      "buyCredits": "Köp Credits",
      "owned": "I din ägo",
      "needMoreTitle": "Mer Credits krävs",
      "needMoreBody": "Du behöver {shortfall} mer Credits för att köpa {item}.",
      "cancel": "Avbryt",
      "confirmTitle": "Bekräfta köp av kosmetika",
      "confirmBody": "Köpa {item} för {cost} Credits?",
      "confirmPurchase": "Köp",
    ...
    "credits": {
      ...
      "open": "Öppna Credits",
      "close": "Stäng Credits",
      "loading": "Laddar Credits...",
      "balanceLabel": "Saldo",
      "balanceUnit": "{amount} Credits",
      "solBalance": "SOL: {amount}",
      "usdcBalance": "USDC: {amount}",
      "wocBalance": "WOC: {amount}",
      "unavailable": "Credits-butiken är inte tillgänglig just nu. Ditt saldo och dina köp påverkas inte. Försök igen om en stund.",
      "disclosure": "Credits är en virtuell valuta som bara går åt ett håll: köp den för pengar och använd den till kosmetika. Den kan inte växlas in, överföras eller betalas ut.",
      "buyTitle": "Köp Credits",
      ...
      "amountLabel": "Belopp",
      "showAmounts": "Visa alla Credits-belopp",
      "hideAmounts": "Dölj extra Credits-belopp",
      "skuRow": "{usd} för {credits} Credits",
      "buyButton": "Köp",
      ...
      "checkoutUnavailable": "Det Credits-köpet är inte tillgängligt just nu.",
      "checkoutWalletRequired": "Anslut en Solana-plånbok innan du köper Credits med krypto.",
      "checkoutWalletUnsupported": "Denna plånbok kan inte signera och skicka Solana-transaktioner.",
      "checkoutNotSettled": "Transaktionen skickades men Credits har inte krediterats ännu. Försök snart igen."
    },
    "theme": {
    ...
    "corpseHarvest": {
      ...
      "harvestTooltip": "Skörda: samla hantverksmaterial från liket (skinn, huggtand, silke och liknande delar), separat från dess byte. Vem som helst kan skörda, men varje lik kan bara skördas av en spelare.",
    ...
    "discord": {
      ...
      "swag": {
        ...
        "titleChampion": "Titel: Champion of Endless Realm",
  ...
  "seo": {
    ...
    "officialBody": "endlessglory.vercel.app är den officiella gratis webbläsar-MMO:n för Endless Realm-världen. Spela online med en beständig karaktär, utforska solo offline, läs wikin och följ verifierade gemenskapslänkar från den här webbplatsen."
  },
  "a11y": {
  ...
  "serverUnavailable": {
    ...
    "body": "Vi startar om speltjänsten och förväntar oss att Endless Realm är tillbaka inom kort. Den här sidan fortsätter att kontrollera automatiskt.",
