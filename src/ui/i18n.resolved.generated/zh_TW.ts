...
export const zh_TW: EnTranslations = {
  ...
  "hudChrome": {
    ...
    "wocStore": {
      ...
      "needMoreBody": "還需要 {shortfall} Credits 才能購買 {item}。",
      "cancel": "取消",
      "confirmTitle": "確認購買外觀",
      "confirmBody": "要用 {cost} Credits 購買 {item} 嗎？",
      "confirmPurchase": "購買",
    ...
    "credits": {
      ...
      "open": "開啟 Credits",
      "close": "關閉 Credits",
      "loading": "正在載入 Credits…",
      "balanceLabel": "餘額",
      "balanceUnit": "{amount} Credits",
      "solBalance": "SOL：{amount}",
      "usdcBalance": "USDC：{amount}",
      "wocBalance": "WOC：{amount}",
      "unavailable": "Credits 商店目前無法使用。您的餘額與購買不受影響，請稍後再試。",
      "disclosure": "Credits 是單向軟貨幣：可用金錢購買並用於兌換外觀物品，不能贖回、轉讓或兌現。",
      "buyTitle": "購買 Credits",
      "railLabel": "付款方式",
      "railStripe": "信用卡",
      "railSol": "SOL",
      ...
      "amountLabel": "數量",
      "showAmounts": "顯示所有 Credits 數量",
      "hideAmounts": "隱藏其他 Credits 數量",
      "skuRow": "{usd} 可購買 {credits} Credits",
      "buyButton": "購買",
      ...
      "checkoutUnavailable": "該 Credits 購買項目目前無法使用。",
      "checkoutWalletRequired": "使用加密貨幣購買 Credits 前，請先連接 Solana 錢包。",
      "checkoutWalletUnsupported": "此錢包無法簽署及傳送 Solana 交易。",
      "checkoutNotSettled": "交易已傳送，但 Credits 尚未入帳，請稍後再試。"
    },
    "theme": {
      "preset": "介面主題",
      "customColors": "自訂顏色",
  ...
  "guide": {
    ...
    "worldPage": {
      ...
      "volcanoBlurb": "焦土遍布、餘燼蔽空的荒原，東溪鎮仍在此屹立不搖。新英雄在此地的灰燼野狼與盜匪之間學會生存。",
      ...
      "volcanoGreeting": "把你的劍帶在身邊。傷痕之地已不復昔日。",
      "volcanoGreeter": "雷德布魯克元帥，東溪鎮",
      ...
      "volcanoPlaceNotes": "東溪鎮是你的第一個主據點。狼徑與灰燼野豬灘是焦土狩獵場；玻璃水湖是礦泉溫熱的水源，儘管淺灘處群聚著泥鰭魚；玄網林與銅礦坑藏著蜘蛛與貪礦的掘地者；強盜營地與倒塌禮拜堂另有更粗野的活計；聖物庫山丘向下通往崩塌的聖物庫，這個王國的第一座秘探；餘燼林地是北方一片稀疏、映著餘燼紅光的林地；而灰燼場則是東溪有圍牆的野豬球場，溪谷盃就在豐收休戰之下於此開賽。",
