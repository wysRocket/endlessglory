...
export const ru_RU: EnTranslations = {
  ...
  "hudChrome": {
    ...
    "wocStore": {
      ...
      "buyCredits": "Купить Credits",
      "owned": "Получено",
      "needMoreTitle": "Требуется больше Credits",
      "needMoreBody": "Для покупки {item} не хватает {shortfall} Credits.",
      "cancel": "Отмена",
      "confirmTitle": "Подтвердить покупку облика",
      "confirmBody": "Купить {item} за {cost} Credits?",
    ...
    "credits": {
      "title": "Credits",
      "open": "Открыть Credits",
      "close": "Закрыть Credits",
      "loading": "Загрузка Credits…",
      "balanceLabel": "Баланс",
      "balanceUnit": "{amount} Credits",
      "solBalance": "SOL: {amount}",
      "usdcBalance": "USDC: {amount}",
      "wocBalance": "WOC: {amount}",
      "unavailable": "Магазин Credits сейчас недоступен. Ваш баланс и покупки не затронуты; повторите попытку позже.",
      "disclosure": "Credits — односторонняя игровая валюта: её можно купить за деньги и потратить на косметические предметы. Её нельзя вернуть, передать или обналичить.",
      "buyTitle": "Купить Credits",
      ...
      "showAmounts": "Показать все варианты Credits",
      "hideAmounts": "Скрыть дополнительные варианты Credits",
      "skuRow": "{credits} Credits за {usd}",
      "buyButton": "Купить",
      ...
      "checkoutUnavailable": "Эта покупка Credits сейчас недоступна.",
      "checkoutWalletRequired": "Подключите кошелёк Solana перед покупкой Credits за криптовалюту.",
      "checkoutWalletUnsupported": "Этот кошелёк не может подписывать и отправлять транзакции Solana.",
      "checkoutNotSettled": "Транзакция отправлена, но Credits ещё не зачислен. Повторите попытку позже."
    },
    "theme": {
    ...
    "discord": {
      ...
      "swag": {
        ...
        "titleChampion": "Титул: Чемпион Endless Realm",
  ...
  "guide": {
    ...
    "worldPage": {
      ...
      "volcanoBlurb": "Выжженная пустошь под тлеющим небом, где город Восточный Брод стоит несломленным. Здесь новые герои учатся выживать среди пепельных волков и разбойников.",
      ...
      "volcanoGreeting": "Держите клинок наготове. Шрам уже не тот, что прежде.",
      "volcanoGreeter": "Маршал Редбрук, Истврук",
  ...
  "seo": {
    ...
    "officialBody": "endlessglory.vercel.app - официальная бесплатная браузерная MMO для мира Endless Realm. Играйте онлайн с постоянным персонажем, исследуйте мир в одиночку офлайн, читайте wiki и переходите по проверенным ссылкам сообщества с этого сайта."
  },
  "a11y": {
  ...
  "serverUnavailable": {
    ...
    "body": "Мы перезапускаем игровой сервис и ожидаем, что Endless Realm скоро вернется. Эта страница продолжит проверку автоматически.",
