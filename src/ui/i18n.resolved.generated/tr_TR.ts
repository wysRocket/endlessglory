...
export const tr_TR: EnTranslations = {
  ...
  "hudChrome": {
    ...
    "wocStore": {
      ...
      "balance": "Credits Bakiyesi",
      "buyCredits": "Credits'u satın al",
      "owned": "Sahip",
      "needMoreTitle": "Daha Fazla Credits Gerekli",
      "needMoreBody": "{item} satın almak için {shortfall} daha fazla Credits'a ihtiyacınız var.",
      "cancel": "İptal",
      "confirmTitle": "Kozmetik Satın Alma İşlemini Onaylayın",
      "confirmBody": "{cost} Credits için {item} satın alınsın mı?",
    ...
    "credits": {
      "title": "Credits",
      "open": "Credits'u aç",
      "close": "Credits'u kapat",
      "loading": "Credits yükleniyor...",
      "balanceLabel": "Bakiye",
      "balanceUnit": "{amount} Credits",
      "solBalance": "SOL: {amount}",
      "usdcBalance": "USDC: {amount}",
      "wocBalance": "WOC: {amount}",
      "unavailable": "Credits mağazası şu anda kullanılamıyor. Bakiyeniz ve satın alımlarınız etkilenmez; lütfen kısa süre sonra tekrar kontrol edin.",
      "disclosure": "Credits tek yönlü yumuşak bir para birimidir: Parayla satın alın ve kozmetik ürünlerine harcayın. Kullanılamaz, devredilemez veya nakde çevrilemez.",
      "buyTitle": "Credits'u satın al",
      ...
      "amountLabel": "Miktar",
      "showAmounts": "Tüm Credits miktarlarını göster",
      "hideAmounts": "Ekstra Credits miktarlarını gizle",
      "skuRow": "{credits} Credits için {usd}",
      "buyButton": "Satın Al",
      ...
      "checkoutUnavailable": "Bu Credits satın alımı şu anda mevcut değil.",
      "checkoutWalletRequired": "Credits'u kriptoyla satın almadan önce bir Solana cüzdanı bağlayın.",
      "checkoutWalletUnsupported": "Bu cüzdan Solana işlemlerini imzalayamaz ve gönderemez.",
      "checkoutNotSettled": "İşlem gönderildi ancak Credits'a henüz para yatırılmadı. Lütfen kısa süre sonra tekrar deneyin."
    },
    "theme": {
    ...
    "corpseHarvest": {
      "title": "Toplama",
      "harvestButton": "Topla",
      "harvestTooltip": "Hasat: Bu cesetten işçilik malzemelerini (deri, diş, ipek ve benzeri bileşenler) herhangi bir ganimetten ayrı olarak toplayın. Herkes hasat yapabilir; belirli bir cesedi yalnızca bir oyuncu toplayabilir.",
