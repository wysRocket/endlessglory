...
export const id_ID: EnTranslations = {
  ...
  "hudChrome": {
    ...
    "wocStore": {
      ...
      "owned": "Dimiliki",
      "needMoreTitle": "Dibutuhkan Lebih Banyak Credits",
      "needMoreBody": "Anda memerlukan {shortfall} lebih banyak Credits untuk membeli {item}.",
      "cancel": "Batal",
      "confirmTitle": "Konfirmasi Pembelian Kosmetik",
      "confirmBody": "Beli {item} untuk {cost} Credits?",
    ...
    "credits": {
      ...
      "open": "Buka Credits",
      "close": "Tutup Credits",
      "loading": "Memuat Credits...",
      "balanceLabel": "Saldo",
      "balanceUnit": "{amount} Credits",
      "solBalance": "SOL: {amount}",
      "usdcBalance": "USDC: {amount}",
      "wocBalance": "WOC: {amount}",
      "unavailable": "Toko Credits tidak tersedia saat ini. Saldo dan pembelian Anda tidak terpengaruh; harap segera periksa kembali.",
      "disclosure": "Credits adalah mata uang lunak satu arah: beli dengan uang dan belanjakan untuk kosmetik. Itu tidak dapat ditebus, ditransfer, atau diuangkan.",
      "buyTitle": "Beli Credits",
      ...
      "amountLabel": "Jumlah",
      "showAmounts": "Tampilkan semua jumlah Credits",
      "hideAmounts": "Sembunyikan jumlah Credits tambahan",
      "skuRow": "{usd} untuk {credits} Credits",
      "buyButton": "Beli",
      ...
      "checkoutUnavailable": "Pembelian Credits tersebut tidak tersedia saat ini.",
      "checkoutWalletRequired": "Hubungkan dompet Solana sebelum membeli Credits dengan kripto.",
      "checkoutWalletUnsupported": "Dompet ini tidak dapat menandatangani dan mengirim transaksi Solana.",
      "checkoutNotSettled": "Transaksi sudah terkirim tetapi Credits belum dikreditkan. Silakan coba lagi sebentar lagi."
    },
    "theme": {
      "preset": "Tema UI",
    ...
    "corpseHarvest": {
      "title": "Panen",
      "harvestButton": "Panen",
      "harvestTooltip": "Panen: kumpulkan bahan kerajinan dari mayat ini (kulit, taring, sutra, dan komponen serupa), pisahkan dari jarahan apa pun. Siapapun bisa memanen; hanya satu pemain yang dapat memanen mayat tertentu.",
