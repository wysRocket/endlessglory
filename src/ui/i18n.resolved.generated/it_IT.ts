...
export const it_IT: EnTranslations = {
  ...
  "hudChrome": {
    ...
    "wocStore": {
      ...
      "owned": "In possesso",
      "needMoreTitle": "Servono altri Credits",
      "needMoreBody": "Ti servono altri {shortfall} Credits per acquistare {item}.",
      "cancel": "Annulla",
      "confirmTitle": "Conferma l'acquisto del cosmetico",
      "confirmBody": "Acquistare {item} per {cost} Credits?",
    ...
    "credits": {
      "title": "Credits",
      "open": "Apri Credits",
      "close": "Chiudi Credits",
      "loading": "Caricamento di Credits...",
      "balanceLabel": "Saldo",
      "balanceUnit": "{amount} Credits",
      "solBalance": "SOL: {amount}",
      "usdcBalance": "Saldo USDC: {amount}",
      "wocBalance": "WOC: {amount}",
      "unavailable": "Il negozio Credits non è disponibile al momento. Il tuo saldo e i tuoi acquisti non subiranno modifiche. Riprova tra poco.",
      "disclosure": "Credits è una valuta virtuale a senso unico: puoi acquistarlo con denaro reale e spenderlo in cosmetici. Non può essere riscattato, trasferito o convertito in denaro.",
      "buyTitle": "Acquista Credits",
      ...
      "showAmounts": "Mostra tutti gli importi di Credits",
      "hideAmounts": "Nascondi importi extra di Credits",
      "skuRow": "{usd} per {credits} Credits",
      "buyButton": "Acquista",
      ...
      "checkoutUnavailable": "L'acquisto di Credits non è disponibile al momento.",
      "checkoutWalletRequired": "Collega un portafoglio Solana prima di acquistare Credits con criptovaluta.",
      "checkoutWalletUnsupported": "Questo portafoglio non può firmare e inviare transazioni Solana.",
      "checkoutNotSettled": "La transazione è stata inviata, ma Credits non è ancora stato accreditato. Riprova tra poco."
    },
    "theme": {
    ...
    "corpseHarvest": {
      ...
      "harvestTooltip": "Raccolta: recupera da questo cadavere materiali per la creazione (pelle, zanne, seta e componenti simili), separati dal bottino. Chiunque può raccogliere, ma ogni cadavere può essere raccolto da un solo giocatore.",
