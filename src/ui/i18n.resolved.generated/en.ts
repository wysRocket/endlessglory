...
export const en: EnTranslations = {
  ...
  "hudChrome": {
    ...
    "credits": {
      ...
      "unavailable": "The Credits store is unavailable right now. Your balance and purchases are unaffected; please check back shortly.",
      "disclosure": "Credits is a one-way soft currency: buy it with money and spend it on cosmetics. It cannot be redeemed, transferred, or cashed out.",
      ...
      "checkoutNotSettled": "The transaction was sent but Credits was not credited yet. Please try again shortly."
    },
    "theme": {
      "preset": "UI Theme",
  ...
  "seo": {
    ...
    "officialBody": "endlessglory.vercel.app is the official free browser MMO for the Endless Realm world. Play online with a persistent character, explore solo offline, read the wiki, and follow verified community links from this site."
  },
  "a11y": {
