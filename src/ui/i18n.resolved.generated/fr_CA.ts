...
export const fr_CA: EnTranslations = {
  ...
  "hudChrome": {
    ...
    "wocStore": {
      ...
      "balance": "Solde de Credits",
      "buyCredits": "Acheter du Credits",
      "owned": "Possédée",
      "needMoreTitle": "Credits supplémentaire requis",
      "needMoreBody": "Il vous faut encore {shortfall} Credits pour acheter {item}.",
      "cancel": "Annuler",
      "confirmTitle": "Confirmer l’achat de l’objet cosmétique",
      "confirmBody": "Acheter {item} pour {cost} Credits ?",
    ...
    "credits": {
      "title": "Credits",
      "open": "Ouvrir le Credits",
      "close": "Fermer le Credits",
      "loading": "Chargement du Credits...",
      "balanceLabel": "Solde",
      "balanceUnit": "{amount} Credits",
      "solBalance": "SOL : {amount}",
      "usdcBalance": "USDC : {amount}",
      "wocBalance": "WOC : {amount}",
      "unavailable": "La boutique de Credits est indisponible pour le moment. Votre solde et vos achats ne sont pas affectés. Veuillez revenir dans quelques instants.",
      "disclosure": "Le Credits est une monnaie virtuelle à sens unique : achetez-en avec de l’argent et dépensez-le en objets cosmétiques. Il ne peut être ni remboursé, ni transféré, ni converti en argent.",
      "buyTitle": "Acheter du Credits",
      ...
      "amountLabel": "Montant",
      "showAmounts": "Afficher tous les montants de Credits",
      "hideAmounts": "Masquer les montants de Credits supplémentaires",
      "skuRow": "{credits} Credits pour {usd}",
      "buyButton": "Acheter",
      ...
      "checkoutUnavailable": "Cet achat de Credits est indisponible pour le moment.",
      "checkoutWalletRequired": "Connectez un portefeuille Solana avant d’acheter du Credits avec des cryptomonnaies.",
      "checkoutWalletUnsupported": "Ce portefeuille ne peut ni signer ni envoyer de transactions Solana.",
      "checkoutNotSettled": "La transaction a été envoyée, mais le Credits n’a pas encore été crédité. Veuillez réessayer dans quelques instants."
    },
    "theme": {
    ...
    "corpseHarvest": {
      ...
      "harvestTooltip": "Dépecer : prélevez sur ce cadavre des matériaux d’artisanat (peau, croc, soie et composants similaires), séparément de son butin. Tout le monde peut le dépecer, mais un cadavre donné ne peut l’être que par un seul joueur.",
    ...
    "discord": {
      ...
      "swag": {
        ...
        "titleChampion": "Titre: Champion de Endless Realm",
  ...
  "seo": {
    ...
    "officialBody": "endlessglory.vercel.app est le MMO gratuit officiel sur navigateur du monde Endless Realm. Jouez en ligne avec un personnage persistant, explorez en solo hors ligne, lisez le wiki et suivez les liens communautaires vérifiés depuis ce site."
  },
  "a11y": {
  ...
  "serverUnavailable": {
    ...
    "body": "Nous redémarrons le service de jeu et Endless Realm devrait revenir sous peu. Cette page continuera de vérifier automatiquement.",
