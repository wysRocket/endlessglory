...
export const de_DE: EnTranslations = {
  ...
  "hudChrome": {
    ...
    "wocStore": {
      ...
      "balance": "Credits-Guthaben",
      "buyCredits": "Credits kaufen",
      "owned": "Im Besitz",
      "needMoreTitle": "Mehr Credits benötigt",
      "needMoreBody": "Dir fehlen {shortfall} Credits, um {item} zu kaufen.",
      "cancel": "Abbrechen",
      "confirmTitle": "Kosmetikkauf bestätigen",
      "confirmBody": "{item} für {cost} Credits kaufen?",
    ...
    "credits": {
      "title": "Credits",
      "open": "Credits-Fenster öffnen",
      "close": "Credits-Fenster schließen",
      "loading": "Credits wird geladen...",
      "balanceLabel": "Guthaben",
      "balanceUnit": "{amount} Credits",
      "solBalance": "SOL: {amount}",
      "usdcBalance": "USDC: {amount}",
      "wocBalance": "WOC: {amount}",
      "unavailable": "Der Credits-Shop ist derzeit nicht verfügbar. Dein Guthaben und deine Käufe bleiben davon unberührt. Bitte versuche es gleich noch einmal.",
      "disclosure": "Credits ist eine nicht rücktauschbare Spielwährung: Du kaufst es mit echtem Geld und gibst es für kosmetische Inhalte aus. Es kann weder eingelöst noch übertragen oder ausgezahlt werden.",
      "buyTitle": "Credits kaufen",
      ...
      "amountLabel": "Menge",
      "showAmounts": "Alle Credits-Mengen anzeigen",
      "hideAmounts": "Zusätzliche Credits-Mengen ausblenden",
      "skuRow": "{credits} Credits für {usd}",
      "buyButton": "Kaufen",
      ...
      "checkoutUnavailable": "Dieser Credits-Kauf ist derzeit nicht verfügbar.",
      "checkoutWalletRequired": "Verbinde eine Solana-Wallet, bevor du Credits mit Kryptowährung kaufst.",
      "checkoutWalletUnsupported": "Diese Wallet kann Solana-Transaktionen weder signieren noch senden.",
      "checkoutNotSettled": "Die Transaktion wurde gesendet, aber das Credits wurde noch nicht gutgeschrieben. Bitte versuche es gleich noch einmal."
    },
    "theme": {
    ...
    "corpseHarvest": {
      ...
      "harvestTooltip": "Verwerten: Sammle Handwerksmaterialien aus diesem Kadaver (Haut, Fangzahn, Seide und ähnliche Komponenten), unabhängig von der Beute. Jeder kann Kadaver verwerten, aber einen bestimmten Kadaver darf nur ein Spieler verwerten.",
    ...
    "discord": {
      ...
      "swag": {
        ...
        "titleChampion": "Titel: Champion von Endless Realm",
  ...
  "seo": {
    ...
    "officialBody": "endlessglory.vercel.app ist das offizielle kostenlose Browser-MMO für die Welt Endless Realm. Spiele online mit einem dauerhaften Charakter, erkunde solo offline, lies das Wiki und folge den verifizierten Community-Links auf dieser Website."
  },
  "a11y": {
  ...
  "serverUnavailable": {
    ...
    "body": "Wir starten den Spieldienst neu und erwarten, dass Endless Realm bald zurückkehrt. Diese Seite prüft automatisch weiter.",
    "status": "Bald zurück"
  },
  "hud": {
    "core": {
