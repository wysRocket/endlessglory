...
export const ko_KR: EnTranslations = {
  ...
  "hudChrome": {
    ...
    "wocStore": {
      ...
      "owned": "보유 중",
      "needMoreTitle": "Credits이 더 필요합니다",
      "needMoreBody": "{item} 구매에 Credits {shortfall}개가 더 필요합니다.",
      "cancel": "취소",
      "confirmTitle": "꾸미기 상품 구매 확인",
      "confirmBody": "{item}을(를) {cost} Credits으로 구매할까요?",
      "confirmPurchase": "구매",
    ...
    "credits": {
      ...
      "open": "Credits 열기",
      "close": "Credits 닫기",
      "loading": "Credits 불러오는 중…",
      "balanceLabel": "잔액",
      "balanceUnit": "{amount} Credits",
      "solBalance": "SOL: {amount}",
      "usdcBalance": "USDC: {amount}",
      "wocBalance": "WOC: {amount}",
      "unavailable": "현재 Credits 상점을 이용할 수 없습니다. 잔액과 구매 내역에는 영향이 없으니 잠시 후 다시 확인해 주세요.",
      "disclosure": "Credits은 단방향 게임 화폐입니다. 현금으로 구매해 꾸미기 상품에 사용할 수 있으며 환전, 양도 또는 현금화할 수 없습니다.",
      "buyTitle": "Credits 구매",
      "railLabel": "결제 수단",
      "railStripe": "카드",
      "railSol": "SOL",
      ...
      "amountLabel": "수량",
      "showAmounts": "모든 Credits 수량 표시",
      "hideAmounts": "추가 Credits 수량 숨기기",
      "skuRow": "{usd}에 {credits} Credits",
      "buyButton": "구매",
      ...
      "checkoutUnavailable": "해당 Credits 구매는 현재 이용할 수 없습니다.",
      "checkoutWalletRequired": "암호화폐로 Credits을 구매하기 전에 Solana 지갑을 연결하세요.",
      "checkoutWalletUnsupported": "이 지갑은 Solana 거래에 서명하거나 전송할 수 없습니다.",
      "checkoutNotSettled": "거래는 전송됐지만 Credits이 아직 지급되지 않았습니다. 잠시 후 다시 시도해 주세요."
    },
    "theme": {
      "preset": "UI 테마",
  ...
  "guide": {
    ...
    "worldPage": {
      ...
      "volcanoBlurb": "불탄 땅과 잉걸빛 하늘이 펼쳐진 황무지에서 동개울 마을은 굴하지 않고 서 있습니다. 새내기 영웅들은 이곳에서 잿빛 늑대와 산적들 사이에서 생존을 배웁니다.",
      ...
      "volcanoGreeting": "칼을 가까이 두시오. 상흔지는 예전 같지 않으니.",
      "volcanoGreeter": "레드브룩 원수, 이스트브룩",
      ...
      "volcanoPlaceNotes": "이스트브룩은 여러분의 첫 본거지입니다. 늑대길과 잿빛 멧돼지 벌판은 불탄 사냥터이고, 유리물빛 호수는 광천처럼 따뜻한 수원이지만 얕은 물가에는 진흙지느러미가 우글거립니다. 흑거미줄과 구리 광산에는 거미와 광석에 굶주린 굴착꾼이 숨어 있고, 도적 야영지와 무너진 예배당은 한층 거친 일거리를 품습니다. 성물실 언덕은 왕국 최초의 탐굴인 무너진 성물실로 내려가는 길이고, 잉걸숲은 북쪽의 듬성듬성하고 잉걸빛으로 물든 숲입니다. 그리고 잿벌판은 담장을 두른 이스트브룩의 보어볼 경기장으로, 수확 휴전 아래 베일 컵이 열리는 곳입니다.",
