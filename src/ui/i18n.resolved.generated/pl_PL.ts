...
export const pl_PL: EnTranslations = {
  ...
  "hudChrome": {
    ...
    "wocStore": {
      ...
      "balance": "Saldo Credits",
      "buyCredits": "Kup Credits",
      "owned": "Posiadane",
      "needMoreTitle": "Potrzeba więcej Credits",
      "needMoreBody": "Potrzebujesz {shortfall} więcej Credits, aby kupić {item}.",
      "cancel": "Anuluj",
      "confirmTitle": "Potwierdź zakup kosmetyków",
      "confirmBody": "Kupić {item} za {cost} Credits?",
      "confirmPurchase": "Kup",
    ...
    "credits": {
      ...
      "loading": "Ładowanie Credits...",
      "balanceLabel": "Saldo",
      "balanceUnit": "{amount} Klaudium",
      "solBalance": "SOL: {amount}",
      "usdcBalance": "USDC: {amount}",
      "wocBalance": "WOC: {amount}",
      "unavailable": "Sklep Credits jest obecnie niedostępny. Nie ma to wpływu na Twoje saldo i zakupy; sprawdź ponownie wkrótce.",
      "disclosure": "Credits to jednokierunkowa miękka waluta: kup ją za pieniądze i wydawaj na kosmetyki. Nie można go wymienić, przenieść ani wypłacić.",
      "buyTitle": "Kup Credits",
      ...
      "amountLabel": "Kwota",
      "showAmounts": "Pokaż wszystkie ilości Credits",
      "hideAmounts": "Ukryj dodatkowe ilości Credits",
      "skuRow": "{usd} dla {credits} Credits",
      "buyButton": "Kup",
      ...
      "checkoutUnavailable": "Ten zakup Credits nie jest obecnie dostępny.",
      "checkoutWalletRequired": "Podłącz portfel Solana przed zakupem Credits za kryptowalutę.",
      "checkoutWalletUnsupported": "Ten portfel nie może podpisywać i wysyłać transakcji Solana.",
      "checkoutNotSettled": "Transakcja została wysłana, ale Credits nie zostało jeszcze zaksięgowane. Spróbuj ponownie wkrótce."
    },
    "theme": {
    ...
    "corpseHarvest": {
      ...
      "harvestTooltip": "Żniwa: zbierz materiały rzemieślnicze z tych zwłok (skórę, kły, jedwab i podobne elementy), oddzielnie od wszelkich łupów. Każdy może zbierać plony; tylko jeden gracz może zebrać dane zwłoki.",
    ...
    "discord": {
      ...
      "swag": {
        ...
        "titleChampion": "Tytuł: Mistrz Endless Realm",
  ...
  "seo": {
    ...
    "officialBody": "endlessglory.vercel.app to oficjalne, darmowe przeglądarkowe MMO dla świata Endless Realm. Graj online z trwałą postacią, eksploruj solo w trybie offline, czytaj wiki i śledź zweryfikowane linki społeczności z tej strony."
  },
  "a11y": {
  ...
  "serverUnavailable": {
    ...
    "body": "Ponownie uruchamiamy usługę gry i spodziewamy się, że Endless Realm wkrótce wróci. Ta strona będzie automatycznie sprawdzać stan.",
