...
export const cs_CZ: EnTranslations = {
  ...
  "hudChrome": {
    ...
    "wocStore": {
      ...
      "balance": "Zůstatek Credits",
      "buyCredits": "Koupit Credits",
      "owned": "Vlastníš",
      "needMoreTitle": "Je potřeba více Credits",
      "needMoreBody": "K nákupu předmětu {item} potřebuješ ještě {shortfall} Credits.",
      "cancel": "Zrušit",
      "confirmTitle": "Potvrdit nákup kosmetiky",
      "confirmBody": "Koupit {item} za {cost} Credits?",
    ...
    "credits": {
      "title": "Credits",
      "open": "Otevřít Credits",
      "close": "Zavřít Credits",
      "loading": "Načítání Credits…",
      "balanceLabel": "Zůstatek",
      "balanceUnit": "{amount} Credits",
      "solBalance": "SOL: {amount}",
      "usdcBalance": "USDC: {amount}",
      "wocBalance": "WOC: {amount}",
      "unavailable": "Obchod Credits nyní není dostupný. Tvůj zůstatek ani nákupy to neovlivní, zkus to za chvíli znovu.",
      "disclosure": "Credits je jednosměrná herní měna: kupuje se za peníze a utrácí za kosmetické předměty. Nelze ji směnit zpět, převést ani vyplatit v hotovosti.",
      "buyTitle": "Koupit Credits",
      ...
      "showAmounts": "Zobrazit všechny nabídky Credits",
      "hideAmounts": "Skrýt další nabídky Credits",
      "skuRow": "{credits} Credits za {usd}",
      "buyButton": "Koupit",
      ...
      "checkoutUnavailable": "Tento nákup Credits nyní není dostupný.",
      "checkoutWalletRequired": "Před nákupem Credits za kryptoměnu připoj peněženku Solana.",
      "checkoutWalletUnsupported": "Tato peněženka neumí podepisovat a odesílat transakce Solana.",
      "checkoutNotSettled": "Transakce byla odeslána, ale Credits zatím nebylo připsáno. Zkus to za chvíli znovu."
    },
    "theme": {
      "preset": "Motiv UI",
    ...
    "corpseHarvest": {
      ...
      "harvestTooltip": "Sklidit: získá z tohoto těla výrobní materiály (kůži, tesák, hedvábí a podobné součásti), odděleně od kořisti. Sklízet může každý, ale dané tělo smí sklidit jen jeden hráč.",
