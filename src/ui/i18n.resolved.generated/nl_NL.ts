...
export const nl_NL: EnTranslations = {
  ...
  "hudChrome": {
    ...
    "wocStore": {
      ...
      "owned": "In bezit",
      "needMoreTitle": "Meer Credits vereist",
      "needMoreBody": "Je hebt {shortfall} meer Credits nodig om {item} te kopen.",
      "cancel": "Annuleren",
      "confirmTitle": "Cosmetische aankoop bevestigen",
      "confirmBody": "{item} voor {cost} Credits kopen?",
    ...
    "credits": {
      "title": "Credits",
      "open": "Credits openen",
      "close": "Credits sluiten",
      "loading": "Credits laden...",
      "balanceLabel": "Saldo",
      "balanceUnit": "{amount} Credits",
      "solBalance": "SOL: {amount}",
      "usdcBalance": "USDC: {amount}",
      "wocBalance": "WOC: {amount}",
      "unavailable": "De Credits-winkel is momenteel niet beschikbaar. Je saldo en aankopen zijn niet aangetast. Probeer het binnenkort opnieuw.",
      "disclosure": "Credits is een virtuele valuta die maar één kant op gaat: koop het met geld en besteed het aan cosmetica. Het kan niet worden ingewisseld, overgedragen of uitbetaald.",
      "buyTitle": "Credits kopen",
      ...
      "showAmounts": "Toon alle Credits-bedragen",
      "hideAmounts": "Verberg extra Credits-bedragen",
      "skuRow": "{usd} voor {credits} Credits",
      "buyButton": "Kopen",
      ...
      "checkoutUnavailable": "Die aankoop van Credits is momenteel niet beschikbaar.",
      "checkoutWalletRequired": "Koppel een Solana-wallet voordat je Credits met cryptovaluta koopt.",
      "checkoutWalletUnsupported": "Deze wallet kan geen Solana-transacties ondertekenen en verzenden.",
      "checkoutNotSettled": "De transactie is verzonden, maar Credits is nog niet gecrediteerd. Probeer het binnenkort opnieuw."
    },
    "theme": {
      "preset": "UI-thema",
    ...
    "corpseHarvest": {
      ...
      "harvestTooltip": "Oogsten: verzamel ambachtsmaterialen van dit lijk (vel, hoektand, zijde en vergelijkbare onderdelen), los van de buit. Iedereen kan oogsten, maar elk lijk kan maar door één speler worden geoogst.",
