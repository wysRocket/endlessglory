...
export const pt_BR: EnTranslations = {
  ...
  "hudChrome": {
    ...
    "wocStore": {
      ...
      "owned": "Adquirido",
      "needMoreTitle": "Mais Credits necessário",
      "needMoreBody": "Você precisa de mais {shortfall} Credits para comprar {item}.",
      "cancel": "Cancelar",
    ...
    "credits": {
      ...
      "unavailable": "A loja Credits não está disponível no momento. Seu saldo e suas compras não serão afetados. Tente novamente em breve.",
      "disclosure": "Credits é uma moeda virtual de mão única: compre-a com dinheiro real e gaste-a em cosméticos. Ela não pode ser resgatada, transferida nem convertida em dinheiro.",
      ...
      "amountLabel": "Quantia",
      "showAmounts": "Mostrar todos os valores de Credits",
      "hideAmounts": "Ocultar valores extras de Credits",
      ...
      "checkoutUnavailable": "Essa compra do Credits não está disponível no momento.",
      "checkoutWalletRequired": "Conecte uma carteira Solana antes de comprar Credits com criptomoedas.",
      "checkoutWalletUnsupported": "Esta carteira não pode assinar e enviar transações Solana.",
      "checkoutNotSettled": "A transação foi enviada, mas Credits ainda não foi creditado. Tente novamente em breve."
    },
    "theme": {
    ...
    "corpseHarvest": {
      ...
      "harvestTooltip": "Coleta: obtenha deste cadáver materiais de criação (couro, presas, seda e componentes semelhantes), separados do saque. Qualquer pessoa pode coletar, mas cada cadáver só pode ser coletado por um jogador.",
    ...
    "discord": {
      ...
      "swag": {
        ...
        "titleChampion": "Título: Campeão de Endless Realm",
  ...
  "seo": {
    ...
    "officialBody": "endlessglory.vercel.app é o MMO de navegador gratuito oficial do mundo Endless Realm. Jogue online com um personagem persistente, explore solo offline, leia a wiki e siga os links verificados da comunidade a partir deste site."
  },
  "a11y": {
  ...
  "serverUnavailable": {
    ...
    "body": "Estamos reiniciando o serviço do jogo e esperamos que Endless Realm volte em breve. Esta página continuará verificando automaticamente.",
