...
export const da_DK: EnTranslations = {
  ...
  "hudChrome": {
    ...
    "wocStore": {
      ...
      "owned": "Du ejer dette",
      "needMoreTitle": "Mere Credits påkrævet",
      "needMoreBody": "Du skal bruge {shortfall} mere Credits for at købe {item}.",
      "cancel": "Annuller",
      "confirmTitle": "Bekræft køb af kosmetik",
      "confirmBody": "Køb {item} til {cost} Credits?",
      "confirmPurchase": "Køb",
    ...
    "credits": {
      ...
      "open": "Åbn Credits",
      "close": "Luk Credits",
      "loading": "Indlæser Credits...",
      "balanceLabel": "Saldo",
      "balanceUnit": "{amount} Credits",
      "solBalance": "SOL: {amount}",
      "usdcBalance": "USDC: {amount}",
      "wocBalance": "WOC: {amount}",
      "unavailable": "Credits-butikken er ikke tilgængelig lige nu. Din saldo og dine køb er ikke påvirket. Prøv igen om lidt.",
      "disclosure": "Credits er en virtuel valuta, der kun går én vej: Køb den for penge, og brug den på kosmetik. Den kan ikke indløses, overføres eller udbetales.",
      "buyTitle": "Køb Credits",
      ...
      "amountLabel": "Beløb",
      "showAmounts": "Vis alle Credits-beløb",
      "hideAmounts": "Skjul ekstra Credits-beløb",
      "skuRow": "{usd} til {credits} Credits",
      "buyButton": "Køb",
      ...
      "checkoutUnavailable": "Dette Credits-køb er ikke tilgængeligt lige nu.",
      "checkoutWalletRequired": "Tilslut en Solana-tegnebog, før du køber Credits med kryptovaluta.",
      "checkoutWalletUnsupported": "Denne tegnebog kan ikke underskrive og sende Solana-transaktioner.",
      "checkoutNotSettled": "Transaktionen blev sendt, men Credits er endnu ikke blevet tilføjet. Prøv igen om lidt."
    },
    "theme": {
      "preset": "UI-tema",
    ...
    "corpseHarvest": {
      "title": "Høst",
      "harvestButton": "Høst",
      "harvestTooltip": "Høst: Saml håndværksmaterialer fra dette lig (skind, hugtænder, silke og lignende dele), uafhængigt af dets bytte. Alle kan høste, men hvert lig kan kun høstes af én spiller.",
