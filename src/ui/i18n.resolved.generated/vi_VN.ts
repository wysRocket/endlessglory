...
export const vi_VN: EnTranslations = {
  ...
  "hudChrome": {
    ...
    "wocStore": {
      ...
      "owned": "Sở hữu",
      "needMoreTitle": "Cần thêm Credits",
      "needMoreBody": "Bạn cần thêm {shortfall} Credits để mua {item}.",
      "cancel": "Hủy",
      "confirmTitle": "Xác nhận mua mỹ phẩm",
      "confirmBody": "Mua {item} với giá {cost} Credits?",
      "confirmPurchase": "Mua",
    ...
    "credits": {
      ...
      "open": "Mở Credits",
      "close": "Đóng Credits",
      "loading": "Đang tải Credits...",
      "balanceLabel": "Số dư",
      "balanceUnit": "{amount} Credits",
      "solBalance": "SOL: {amount}",
      "usdcBalance": "USDC: {amount}",
      "wocBalance": "WOC: {amount}",
      "unavailable": "Cửa hàng Credits hiện không có sẵn. Số dư và giao dịch mua hàng của bạn không bị ảnh hưởng; vui lòng kiểm tra lại trong thời gian ngắn.",
      "disclosure": "Credits là loại tiền mềm một chiều: mua bằng tiền và tiêu vào mỹ phẩm. Nó không thể được đổi, chuyển nhượng hoặc rút tiền mặt.",
      "buyTitle": "Mua Credits",
      ...
      "showAmounts": "Hiển thị tất cả số lượng Credits",
      "hideAmounts": "Ẩn số lượng Credits bổ sung",
      "skuRow": "{usd} đổi lấy {credits} Credits",
      "buyButton": "Mua",
      ...
      "checkoutUnavailable": "Việc mua Credits đó hiện không khả dụng.",
      "checkoutWalletRequired": "Kết nối ví Solana trước khi mua Credits bằng tiền điện tử.",
      "checkoutWalletUnsupported": "Ví này không thể ký và gửi giao dịch Solana.",
      "checkoutNotSettled": "Giao dịch đã được gửi nhưng Credits vẫn chưa được ghi có. Vui lòng thử lại trong thời gian ngắn."
    },
    "theme": {
      "preset": "Giao Diện UI",
    ...
    "corpseHarvest": {
      ...
      "harvestTooltip": "Thu hoạch: thu thập nguyên liệu chế tạo từ xác chết này (da, răng nanh, lụa và các thành phần tương tự), tách biệt với bất kỳ chiến lợi phẩm nào. Bất cứ ai cũng có thể thu hoạch; chỉ một người chơi có thể thu hoạch một xác chết nhất định.",
