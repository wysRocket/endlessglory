...
export const ja_JP: EnTranslations = {
  ...
  "hudChrome": {
    ...
    "wocStore": {
      ...
      "balance": "Credits残高",
      "buyCredits": "Creditsを購入",
      "owned": "所有済み",
      "needMoreTitle": "Creditsが不足しています",
      "needMoreBody": "{item}の購入にはあと{shortfall} Credits必要です。",
      "cancel": "キャンセル",
      "confirmTitle": "外見の購入を確認",
      "confirmBody": "{item}を{cost} Creditsで購入しますか？",
      "confirmPurchase": "購入",
    ...
    "credits": {
      ...
      "open": "Creditsを開く",
      "close": "Creditsを閉じる",
      "loading": "Creditsを読み込み中…",
      "balanceLabel": "残高",
      "balanceUnit": "{amount} Credits",
      "solBalance": "SOL：{amount}",
      "usdcBalance": "USDC：{amount}",
      "wocBalance": "WOC：{amount}",
      "unavailable": "Creditsストアは現在利用できません。残高と購入内容に影響はありません。しばらくしてからお試しください。",
      "disclosure": "Creditsは一方向のゲーム内通貨です。現金で購入して外見アイテムに使用でき、換金、譲渡、払い戻しはできません。",
      "buyTitle": "Creditsを購入",
      "railLabel": "支払い方法",
      "railStripe": "カード",
      "railSol": "SOL",
      ...
      "amountLabel": "数量",
      "showAmounts": "すべてのCredits数量を表示",
      "hideAmounts": "追加のCredits数量を隠す",
      "skuRow": "{usd}で{credits} Credits",
      "buyButton": "購入",
      ...
      "checkoutUnavailable": "そのCredits購入は現在利用できません。",
      "checkoutWalletRequired": "暗号資産でCreditsを購入する前にSolanaウォレットを接続してください。",
      "checkoutWalletUnsupported": "このウォレットではSolana取引の署名と送信ができません。",
      "checkoutNotSettled": "取引は送信されましたが、Creditsはまだ反映されていません。しばらくしてからお試しください。"
    },
    "theme": {
      "preset": "UIテーマ",
  ...
  "guide": {
    ...
    "worldPage": {
      ...
      "volcanoBlurb": "焼け焦げた大地と灰燼の空が広がる荒野で、イーストブルックは屈することなく立っています。新たな英雄たちは、ここで灰色のオオカミや盗賊を相手に生き延びる術を学びます。",
      ...
      "volcanoGreeting": "刃を手放すな。爪痕の地はかつての姿ではない。",
      "volcanoGreeter": "レッドブルック元帥、イーストブルック",
      ...
      "volcanoPlaceNotes": "イーストブルックは最初の本拠地です。狼の道と灰の猪原は焼け焦げた狩り場、硝子水の湖は鉱泉のように温かい水場ですが、浅瀬にはマッドフィンが群れています。セイブルウェブと銅鉱山には蜘蛛と鉱石に貪欲な掘り手が隠れ、盗賊の野営地と倒れた礼拝堂にはより手荒い仕事があります。聖遺物庫の丘はレルム初のデルヴ、崩れた聖遺物庫へと落ち込み、エンバーウッドの林間は北にあるまばらな、燠火色に染まった木立です。そしてシンダーフィールドはイーストブルックの壁に囲まれたボアボール場で、収穫休戦のもとヴェイルカップが行われます。",
