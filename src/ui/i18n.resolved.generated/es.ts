...
export const es: EnTranslations = {
  ...
  "hudChrome": {
    ...
    "wocStore": {
      ...
      "balance": "Saldo de Credits",
      "buyCredits": "Comprar Credits",
      "owned": "Adquirido",
      "needMoreTitle": "Necesitas más Credits",
      "needMoreBody": "Te faltan {shortfall} Credits para comprar {item}.",
      "cancel": "Cancelar",
      "confirmTitle": "Confirmar compra de cosmético",
      "confirmBody": "¿Comprar {item} por {cost} Credits?",
    ...
    "credits": {
      "title": "Credits",
      "open": "Abrir Credits",
      "close": "Cerrar Credits",
      "loading": "Cargando Credits...",
      "balanceLabel": "Saldo",
      "balanceUnit": "{amount} Credits",
      "solBalance": "SOL: {amount}",
      "usdcBalance": "Saldo en USDC: {amount}",
      "wocBalance": "WOC: {amount}",
      "unavailable": "La tienda de Credits no está disponible en este momento. Tu saldo y tus compras no se verán afectados; vuelve a intentarlo dentro de poco.",
      "disclosure": "Credits es una moneda virtual unidireccional: se compra con dinero y se gasta en cosméticos. No se puede canjear, transferir ni convertir en dinero.",
      "buyTitle": "Comprar Credits",
      ...
      "showAmounts": "Mostrar todas las cantidades de Credits",
      "hideAmounts": "Ocultar cantidades adicionales de Credits",
      "skuRow": "{credits} Credits por {usd}",
      "buyButton": "Comprar",
      ...
      "checkoutUnavailable": "Esa compra de Credits no está disponible en este momento.",
      "checkoutWalletRequired": "Conecta una cartera de Solana antes de comprar Credits con criptomonedas.",
      "checkoutWalletUnsupported": "Esta cartera no puede firmar ni enviar transacciones de Solana.",
      "checkoutNotSettled": "La transacción se envió, pero el Credits aún no se ha abonado. Vuelve a intentarlo dentro de poco."
    },
    "theme": {
    ...
    "corpseHarvest": {
      ...
      "harvestTooltip": "Recolectar: obtén materiales de artesanía de este cadáver (piel, colmillos, seda y componentes similares), por separado del botín. Cualquiera puede recolectarlo, pero solo un jugador puede recolectar cada cadáver.",
    ...
    "discord": {
      ...
      "swag": {
        ...
        "titleChampion": "Título: Campeón de Endless Realm",
  ...
  "seo": {
    ...
    "officialBody": "endlessglory.vercel.app es el MMO de navegador gratuito oficial del mundo Endless Realm. Juega en línea con un personaje persistente, explora en solitario sin conexión, lee la wiki y sigue los enlaces comunitarios verificados desde este sitio."
  },
  "a11y": {
  ...
  "serverUnavailable": {
    ...
    "body": "Estamos reiniciando el servicio del juego y esperamos que Endless Realm vuelva pronto. Esta página seguirá comprobándolo automáticamente.",
