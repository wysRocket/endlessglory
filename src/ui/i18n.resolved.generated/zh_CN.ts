...
export const zh_CN: EnTranslations = {
  ...
  "hudChrome": {
    ...
    "wocStore": {
      ...
      "owned": "已拥有",
      "needMoreTitle": "需要更多 Credits",
      "needMoreBody": "还需要 {shortfall} Credits 才能购买 {item}。",
      "cancel": "取消",
      "confirmTitle": "确认购买外观",
      "confirmBody": "要用 {cost} Credits 购买 {item} 吗？",
      "confirmPurchase": "购买",
    ...
    "credits": {
      ...
      "open": "打开 Credits",
      "close": "关闭 Credits",
      "loading": "正在加载 Credits…",
      "balanceLabel": "余额",
      "balanceUnit": "{amount} Credits",
      "solBalance": "SOL：{amount}",
      "usdcBalance": "USDC：{amount}",
      "wocBalance": "WOC：{amount}",
      "unavailable": "Credits 商店暂时不可用。您的余额和购买不会受到影响，请稍后再试。",
      "disclosure": "Credits 是单向软货币：可用真钱购买并用于兑换外观物品，不能赎回、转让或兑现。",
      "buyTitle": "购买 Credits",
      "railLabel": "付款方式",
      "railStripe": "银行卡",
      "railSol": "SOL",
      ...
      "amountLabel": "数量",
      "showAmounts": "显示所有 Credits 数量",
      "hideAmounts": "隐藏其他 Credits 数量",
      "skuRow": "{usd} 可购买 {credits} Credits",
      "buyButton": "购买",
      ...
      "checkoutUnavailable": "该 Credits 购买项目暂时不可用。",
      "checkoutWalletRequired": "使用加密货币购买 Credits 前，请先连接 Solana 钱包。",
      "checkoutWalletUnsupported": "此钱包无法签署和发送 Solana 交易。",
      "checkoutNotSettled": "交易已发送，但 Credits 尚未到账，请稍后重试。"
    },
    "theme": {
      "preset": "界面主题",
      "customColors": "自定义颜色",
    ...
    "auth": {
      ...
      "googleLoginCta": "通过 Google 继续",
      "googleError": "无法通过 Google 登录。请重试。",
    ...
    "discord": {
      ...
      "swag": {
        ...
        "titleChampion": "称号：Endless Realm 勇士",
  ...
  "guide": {
    ...
    "worldPage": {
      ...
      "volcanoBlurb": "焦土遍地、余烬蔽空的荒原，东溪镇仍在此地屹立不倒。新英雄在这里的灰烬野狼与盗匪之间学会生存。",
      ...
      "volcanoGreeting": "把你的刀剑带在身边。伤痕地已不复往日。",
      "volcanoGreeter": "雷德布鲁克元帅，东溪",
      ...
      "volcanoPlaceNotes": "东溪镇是你的第一个大本营。狼奔谷与灰烬野猪滩是焦土狩猎场；玻璃水湖是矿泉温热的水源，只是浅滩处泥鳍鱼成群；墨网林与铜矿坑藏着蜘蛛和贪婪掘矿的家伙；一处强盗营地与陷落礼拜堂里有更棘手的活儿；圣物库山丘向下通往坍塌的圣物库，这是王国的第一座探秘；余烬林地是北方一片稀疏、映着余烬红光的林地；而灰烬场则是东溪镇有围墙的野猪球场，溪谷杯就在丰收休战的庇护下在那里开赛。",
  ...
  "seo": {
    ...
    "officialBody": "endlessglory.vercel.app 是 Endless Realm 世界的官方免费浏览器 MMO。你可以用持久角色在线游玩，也可以离线单人探索，阅读 wiki，并从本站访问已验证的社区链接。"
  },
  "a11y": {
    "goHome": "前往主页",
    "toggleMenu": "切换菜单",
  ...
  "serverUnavailable": {
    ...
    "eyebrow": "服务器维护",
    "heading": "服务器暂时不可用。",
    "body": "我们正在重启游戏服务，Endless Realm 应会很快恢复。此页面会自动继续检查。",
    "status": "即将恢复"
  },
  "welcome": {
    "back": "欢迎回来，{name}",
