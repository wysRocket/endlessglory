# WOC Store and Credits packs

The WOC Store reads cosmetic availability, Credits costs, balances, and purchase results from
...
used by established game storefronts while keeping the one Credits equals USD 0.01 display peg.

| Pack key | USD price | Credits credited | Bonus over peg |
|---|---:|---:|---:|
| `credits_500` | $4.99 | 500 | 1 |
| `credits_1050` | $9.99 | 1,050 | 51 |
| `credits_2200` | $19.99 | 2,200 | 201 |
| `credits_4000` | $34.99 | 4,000 | 501 |
| `credits_6000` | $49.99 | 6,000 | 1,001 |
| `credits_13000` | $99.99 | 13,000 | 3,001 |
...
STRIPE_PRICE_CREDITS_1050
STRIPE_PRICE_CREDITS_2200
STRIPE_PRICE_CREDITS_4000
STRIPE_PRICE_CREDITS_6000
STRIPE_PRICE_CREDITS_13000
```
...
server (`server/credits_proxy.ts`); the economy service decides which rails are offered via its
...
`catalogs/credits_catalog.season1.json`; it is the sole authority for availability and Credits
...
| Collection | Credits cost | Service `itemId` values |
|---|---:|---|
...
weapon storefront. Keep product IDs in lockstep across both registries. Update Credits costs only
