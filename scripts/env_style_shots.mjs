// Before/after proof for the house surface style applied to environment
// materials (props, dungeon dressing, scenery).
//
...
const OUT = 'docs/screenshots/env-house-style';
...
const VANTAGES = [
  { name: 'town-props', x: 0, z: -2 },
  { name: 'market-stalls', x: 14, z: 6 },
];
