...
master. `credits_coin_master.png` is a PNG convenience copy of the coin.

| File (base) | Use in UI | Format / sizes |
|---|---|---|
| `credits_coin` | The Credits mark. Balance readout, any "Credits" amount, currency chip. | WebP 1024/512/256/128/64 (+ PNG master) |
| `icon_wallet` | Balance / wallet entry point. | WebP 1024/512/256/128/64 |
| `icon_buy` | "Buy Credits" action (coin + plus badge). | WebP 1024/512/256/128/64 |
...
| `../credits_coin_hero_3q` | Hero / marketing 3-4 angle of the coin. | WebP 1400w |
...
(`src/ui/credits_window.ts`), not Recraft output, and ship as single-size
