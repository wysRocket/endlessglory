...
describe('i18n whole-catalog completeness', () => {
  ...
  it('non-Latin player surfaces ship no untranslated English', () => {
    const BRAND_ALLOW = new Set([
      ...
      'hudChrome.credits.title', // "Credits" - in-game currency brand
      'hudChrome.credits.balanceUnit', // "{amount} Credits" - currency brand
      'hudChrome.credits.storeCost', // "{amount} Credits" - currency brand
