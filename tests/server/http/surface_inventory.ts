...
export const SURFACE_INVENTORY: readonly SurfaceRoute[] = [
  ...
  // (server/credits.ts). A new /api/credits/* prefix served by BOTH the migrated
  // RouteDefs and a legacy handleApi prefix arm (startsWith('/api/credits') ->
  // handleCreditsApi), the same twin shape as daily-rewards. The exact-path arms
  // (and the price/:rail Match regex) live in server/credits.ts, which is a
  ...
  // session); price/:rail is a public enum param, not an account-owned resource.
  {
    ...
    handler: 'handleCreditsStripeWebhook',
    contentType: PROBLEM_JSON,
    authScope: AUTH_SCOPE.public,
    limiter: null,
    requireOwnedExpected: null,
  },
  {
    ...
    handler: 'handleCreditsApi arm: /api/credits/balance',
    contentType: PROBLEM_JSON,
    authScope: AUTH_SCOPE.full,
    limiter: null,
    requireOwnedExpected: null,
  },
  {
    ...
    handler: 'handleCreditsApi arm: /api/credits/price/:rail',
    contentType: PROBLEM_JSON,
    authScope: AUTH_SCOPE.full,
    limiter: null,
    requireOwnedExpected: null,
    match: /^\/api\/credits\/price\/(\w+)$/,
  },
  {
    dispatcher: DISPATCH.mainApi,
    method: 'GET',
    path: '/api/credits/skus',
    handler: 'handleCreditsApi arm: /api/credits/skus',
    contentType: PROBLEM_JSON,
    authScope: AUTH_SCOPE.full,
    limiter: null,
    requireOwnedExpected: null,
  },
  {
    ...
    handler: 'handleCreditsApi arm: /api/credits/native/rails',
    contentType: PROBLEM_JSON,
    authScope: AUTH_SCOPE.full,
    limiter: null,
    requireOwnedExpected: null,
  },
  {
    ...
    handler: 'handleCreditsApi arm: /api/credits/native/price/:rail',
    contentType: PROBLEM_JSON,
    authScope: AUTH_SCOPE.full,
    limiter: null,
    requireOwnedExpected: null,
    match: /^\/api\/credits\/native\/price\/(\w+)$/,
  },
  {
    dispatcher: DISPATCH.mainApi,
    method: 'GET',
    path: '/api/credits/native/balance/sol/:owner',
    handler: 'handleCreditsApi arm: /api/credits/native/balance/sol/:owner',
    contentType: PROBLEM_JSON,
    authScope: AUTH_SCOPE.full,
    limiter: null,
    requireOwnedExpected: null,
    match: /^\/api\/credits\/native\/balance\/sol\/(\w+)$/,
  },
  {
    dispatcher: DISPATCH.mainApi,
    method: 'GET',
    path: '/api/credits/native/balance/usdc/:owner',
    handler: 'handleCreditsApi arm: /api/credits/native/balance/usdc/:owner',
    contentType: PROBLEM_JSON,
    authScope: AUTH_SCOPE.full,
    limiter: null,
    requireOwnedExpected: null,
    match: /^\/api\/credits\/native\/balance\/usdc\/(\w+)$/,
  },
  {
    dispatcher: DISPATCH.mainApi,
    method: 'GET',
    path: '/api/credits/store',
    handler: 'handleCreditsApi arm: /api/credits/store',
    contentType: PROBLEM_JSON,
    authScope: AUTH_SCOPE.full,
    limiter: null,
    requireOwnedExpected: null,
  },
  {
    ...
    handler: 'handleCreditsApi arm: /api/credits/history',
    contentType: PROBLEM_JSON,
    authScope: AUTH_SCOPE.full,
    limiter: null,
    requireOwnedExpected: null,
  },
  {
    ...
    handler: 'handleCreditsApi arm: /api/credits/purchase',
    contentType: PROBLEM_JSON,
    authScope: AUTH_SCOPE.full,
    limiter: 'creditsMutationRateLimited',
    requireOwnedExpected: null,
  },
  {
    dispatcher: DISPATCH.mainApi,
    ...
    handler: 'handleCreditsApi arm: /api/credits/native/quote',
    contentType: PROBLEM_JSON,
    authScope: AUTH_SCOPE.full,
    limiter: 'creditsMutationRateLimited',
    requireOwnedExpected: null,
  },
  {
    ...
    handler: 'handleCreditsApi arm: /api/credits/native/confirm',
    contentType: PROBLEM_JSON,
    authScope: AUTH_SCOPE.full,
    limiter: 'creditsMutationRateLimited',
    requireOwnedExpected: null,
  },
  {
    ...
    handler: 'handleCreditsApi arm: /api/credits/spend',
    contentType: PROBLEM_JSON,
    authScope: AUTH_SCOPE.full,
    limiter: 'creditsMutationRateLimited',
    requireOwnedExpected: null,
