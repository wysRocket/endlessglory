...
describe('rateLimit: policy derivation guard', () => {
  it('every policy limit === its named constant and windowSeconds === WINDOW_MS / 1000', () => {
    ...
    const table: ReadonlyArray<{ policy: RateLimitPolicy; limit: number }> = [
      ...
      { policy: CREDITS_PURCHASE_PRE_AUTH_POLICY, limit: CREDITS_PURCHASE_MAX_PER_MINUTE },
      { policy: CREDITS_QUOTE_PRE_AUTH_POLICY, limit: CREDITS_QUOTE_MAX_PER_MINUTE },
      { policy: CREDITS_CONFIRM_PRE_AUTH_POLICY, limit: CREDITS_CONFIRM_MAX_PER_MINUTE },
      { policy: CREDITS_SPEND_PRE_AUTH_POLICY, limit: CREDITS_SPEND_MAX_PER_MINUTE },
      { policy: CREDITS_PURCHASE_POLICY, limit: CREDITS_PURCHASE_MAX_PER_MINUTE },
      { policy: CREDITS_QUOTE_POLICY, limit: CREDITS_QUOTE_MAX_PER_MINUTE },
      { policy: CREDITS_CONFIRM_POLICY, limit: CREDITS_CONFIRM_MAX_PER_MINUTE },
      { policy: CREDITS_SPEND_POLICY, limit: CREDITS_SPEND_MAX_PER_MINUTE },
