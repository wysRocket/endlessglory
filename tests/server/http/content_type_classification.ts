...
export const API_CONTENT_TYPE: Readonly<Record<string, ContentTypeClass>> = {
  ...
  '/api/credits/stripe/webhook': PROBLEM_JSON,
  '/api/credits/balance': PROBLEM_JSON,
  '/api/credits/price/:rail': PROBLEM_JSON,
  '/api/credits/skus': PROBLEM_JSON,
  '/api/credits/native/rails': PROBLEM_JSON,
  '/api/credits/native/price/:rail': PROBLEM_JSON,
  '/api/credits/native/balance/sol/:owner': PROBLEM_JSON,
  '/api/credits/native/balance/usdc/:owner': PROBLEM_JSON,
  '/api/credits/native/quote': PROBLEM_JSON,
  '/api/credits/native/confirm': PROBLEM_JSON,
  '/api/credits/store': PROBLEM_JSON,
  '/api/credits/history': PROBLEM_JSON,
  '/api/credits/purchase': PROBLEM_JSON,
  '/api/credits/spend': PROBLEM_JSON,
